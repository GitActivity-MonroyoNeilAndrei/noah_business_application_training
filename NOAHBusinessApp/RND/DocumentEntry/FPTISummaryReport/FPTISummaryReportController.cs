...
{
    public class FPTISummaryReportController : nwStandardGateway
    {
        public ActionResult Index()
        {
           mainDataAccess main = new mainDataAccess();
            ...
            return View(@"~\RND\DocumentEntry\FPTISummaryReport\FPTISummaryReport.cshtml");
        }
        ...
        public ActionResult Index2()
        {
            Response.Write("AA1");
            return null;
            //return View(@"~\SA\DataSetup\FPTISummaryReport\FPTISummaryReport.cshtml");
        }

        public ActionResult FPTISummaryReport_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    FPTISummaryReportBL menuBL = new FPTISummaryReportBL();
