...
{
    public class SGEmployeeTypeBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            //Addchars();
            dal = new SGEmployeeTypeDAL(this.UserDefinedConnectionString, based.SecurityAccess.ConnectionString, "");
