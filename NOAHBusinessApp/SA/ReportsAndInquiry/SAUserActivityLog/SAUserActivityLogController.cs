...
{
    public class SAUserActivityLogController : nwStandardGateway
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(@"~\SA\ReportsAndInquiry\SAUserActivityLog\SAUserActivityLog.cshtml");

        }

        public ActionResult SAUserActivityLog_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    SAUserActivityLogBL menuBL = new SAUserActivityLogBL();
                    based.Title = "Payment Request Entry";
