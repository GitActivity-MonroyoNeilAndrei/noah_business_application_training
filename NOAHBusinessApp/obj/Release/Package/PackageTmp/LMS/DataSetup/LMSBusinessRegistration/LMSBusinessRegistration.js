function func_Reload() {
    crLnk = GetCurrentURL() + "LMSBusinessRegistration_Gateway";
    crLnkGateKey = "LMSBusinessRegistration";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Would you like to save the current record?", "Business Registration", "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Would you like to delete the current record?", "Business Registration", "", indef, enume);
    isContinue = false;
    return isContinue;
}
