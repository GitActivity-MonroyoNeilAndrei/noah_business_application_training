...
baseTitle = "BIR Forms Authorized Signatory Assignment";


var  SPR_BIRFORMCODE = 1,
     SPR_BIRFORMNAME = 2;
...
function func_Reload() {
    crLnk = GetCurrentURL() + "APBIRFormsAuthorizedSignatoryAssignment_Gateway";
    crLnkGateKey = "APBIRFormsAuthorizedSignatoryAssignment";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Do you want to save the current record?", 'BIR Forms Authorized Signatory Assignment', "", indef, enume);
    isContinue = false;
...
function func_ToolboxProcess(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Do you want to process the current record?", 'BIR Forms Authorized Signatory Assignment', "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Do you want to delete the current record?", 'BIR Forms Authorized Signatory Assignment', "", indef, enume);
    isContinue = false;
    return isContinue;
}
...
function cust_GetPara() {
    ...
    nwParameter_Add("dtpEffectiveDate", $("#dtpEffectiveDate").val());
    nwParameter_Add("lugBIRAuthoSign", $("#lugBIRAuthoSign").val());

    console.log($("#lugLocation").val());
    console.log($("#lugBIRAuthoSign").val());
...
function EnableFields() {
    ...
    $("#dtpEffectiveDate").enable(true);
    $("#lugBIRAuthoSign").enable(true);
...
function DisableFields() {
    ...
    $("#dtpEffectiveDate").enable(false);
    $("#lugBIRAuthoSign").enable(false);
    $("#lugDesignation").enable(false);
    $("#txtTaxIdentificationNum").enable(false);
...
$(document).on("click", "#btnCopyFrom", function (e) {
    ...
    if ($('#idvallugVendor').val() == '') {
        MessageBox("Cannot proceed. Please complete the header details.", 'BIR Forms Authorized Signatory Assignment');
        return true;
    }
