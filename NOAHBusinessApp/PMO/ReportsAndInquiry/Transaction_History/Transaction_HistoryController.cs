...
{
    public class Transaction_HistoryController : nwStandardGateway
    {
        public ActionResult Index()
        {
            mainDataAccess main = new mainDataAccess();
            main.MenuAccess(User, this);
            return View(@"~\RE\ReportsAndInquiry\Transaction_History\Transaction_History.cshtml");
        }
        ...
        public ActionResult Index2()
        {
            Response.Write("AA1");
            return null;
            //return View(@"~\RE\ReportsAndInquiry\Transaction_History\Transaction_History2.cshtml");
        }


        public ActionResult Transaction_History_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    Transaction_HistoryBL menuBL = new Transaction_HistoryBL();
                    based.Title = "Basic Information";
