...
{
    public class SBMyProspectCustomers_HealthDeclarationBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            //Addchars();
            dal = new SBMyProspectCustomers_HealthDeclarationDAL(this.UserDefinedConnectionString, based.SecurityAccess.ConnectionString, "");
        ...
        SBMyProspectCustomers_HealthDeclarationDAL dal;
        //int xtotalrecords = 0;
        Dictionary<string, string> xdic_chars = new Dictionary<string, string>();

        public SBMyProspectCustomers_HealthDeclarationBL()
        {
            ...
            switch (i)
            {
                ...
                case eRecordOperation.Save:
                    ...
                    if (RecordOperationResult.Length <= 0)
                    {
                        ...
                        RecordOperationResult = dal.ProcessData(
                            WebApp.nwobjectText("txtHCode"),
                            WebApp.nwobjectText("txtDateToday"),
                            WebApp.nwobjectText("txtBodyTemp"),
                            WebApp.nwobjectText("cmbSicknessPI"),
                            WebApp.nwobjectText("txtOthersSickness"),
                            WebApp.nwobjectText("txtOthersLocation"),
                            WebApp.nwobjectText("txtOthersDate"),
                            WebApp.nwobjectBool("cbYes") == true ? 1 : 0,
                            WebApp.nwobjectBool("cbYes1") == true ? 1 : 0,
                            WebApp.nwobjectBool("cbYes2") == true ? 1 : 0,
                            WebApp.nwobjectText("txtHPCode"));
        ...
        private void SetBindings()
        {
            ...
            SFObject.SetControlBinding("#cmbSicknessPI", "Val", "", "#noah-webui-Toolbox-BindingNavigator", "Symptoms");
            SFObject.SetControlBinding("#txtOthersSickness", "Val", "", "#noah-webui-Toolbox-BindingNavigator", "SymptomsOthers");
            SFObject.SetControlBinding("#cbYes", "prop", "checked", "#noah-webui-Toolbox-BindingNavigator", "HDYes");
            SFObject.SetControlBinding("#cbNo", "prop", "checked", "#noah-webui-Toolbox-BindingNavigator", "HDNo");
            SFObject.SetControlBinding("#cbYes1", "prop", "checked", "#noah-webui-Toolbox-BindingNavigator", "HDYes1");
            SFObject.SetControlBinding("#cbNo1", "prop", "checked", "#noah-webui-Toolbox-BindingNavigator", "HDNo1");
            SFObject.SetControlBinding("#cbYes2", "prop", "checked", "#noah-webui-Toolbox-BindingNavigator", "HDYes2");
            SFObject.SetControlBinding("#cbNo2", "prop", "checked", "#noah-webui-Toolbox-BindingNavigator", "HDNo2");
        ...
        private void BindCollection()
        {
            ...
            js.ADD("CheckIfOthers('cmbSicknessPI');");
            ...
            if (WebApp.nwobjectBool("cbYes") == true)
                js.ADD("func_SickToday('Y')");
            else
                js.ADD("func_SickToday('N')");

            if (WebApp.nwobjectBool("cbYes1") == true)
                js.ADD("func_Traveled('Y')");
            else
                js.ADD("func_Traveled('N')");

            if (WebApp.nwobjectBool("cbYes2") == true)
                js.ADD("func_CloseCont('Y')");
            else
                js.ADD("func_CloseCont('N')");
        ...
        {
            js.ADD("cust_GetPara();");
            bool validateYesSickness = WebApp.nwobjectBool("cbYes");
            bool validateNoSickness = WebApp.nwobjectBool("cbNo");
            bool validateYesTrav = WebApp.nwobjectBool("cbYes1");
            bool validateNoTrav = WebApp.nwobjectBool("cbNo1");
            bool validateYesCloseCon = WebApp.nwobjectBool("cbYes2");
            bool validateNoCloseCon = WebApp.nwobjectBool("cbNo2");
            ...
            if (WebApp.nwobjectText("txtDateToday").Length <= 0)
                errorResult += "Cannot be processed. Date is required.\n";
            if (WebApp.nwobjectText("txtBodyTemp").Length <= 0)
                errorResult += "Cannot be processed. Body Temperature is required.\n";
            if (validateYesSickness == false && validateNoSickness == false)
                validateYesSickness = true;

            if (validateYesTrav == false && validateNoTrav == false)
                validateYesTrav = true;

            if (validateYesCloseCon == false && validateNoCloseCon == false)
                validateYesCloseCon = true;

            if (validateYesSickness == true)
            { 
            if (WebApp.nwobjectText("cmbSicknessPI").Length <= 0)
                errorResult += "Cannot be processed. Sickness/Symptoms is required.\n";
            }

            //if ((WebApp.nwobjectText("txtMobileNum").Length <= 0) && (WebApp.nwobjectText("txtEAdd").Length <= 0))
            //{
            //    errorResult += "Cannot be processed.\nPlease input either Email Address or Mobile Number.\n";
            //}
        ...
        public DataSet LoadSchema()
        {
            ...
            for (int i = 0; i < ds.Tables.Count; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 9://health dec
                        dr["CustomerCode"] = WebApp.nwobjectText("txtCode");
                        dr["DateToday"] = WebApp.nwobjectText("txtDateToday");//
                        dr["Bodytemp"] = WebApp.nwobjectText("txtBodyTemp");
                        dr["isSickToday"] = WebApp.nwobjectBool("cbYes") == true ? 1 : 0;
                        dr["Symptoms"] = WebApp.nwobjectText("cmbSicknessPI");//
                        dr["SymptomsOthers"] = WebApp.nwobjectText("txtOthersSickness");//
                        dr["isTraveled"] = WebApp.nwobjectBool("cbYes1") == true ? 1 : 0;
                        dr["LocOthers"] = WebApp.nwobjectText("txtEmailPI");//
                        dr["isCloseContact"] = WebApp.nwobjectBool("cbYes2") == true ? 1 : 0;
                        dr["DateOthers"] = WebApp.nwobjectText("txtOthersDate");//
        ...
        private void Main_Load()
        {
            ...
            //string proscode = dal.GetNewProsCustCode();
        ...
        public void LoadCombos()
        {
            ...
            for (int i = 0; i < dsData.Tables.Count; i++)
            {
                switch (i)//class/id affected
                {
                    ...
                    case 22: value = ".cmbSalesActivityPI"; break; 
                    case 23: value = ".cmbPriceRange"; break; //Price Range
                    case 24: value = ".cmbBusinessType"; break;
                    case 25: value = ".cmbSicknessPI"; break;
                }
