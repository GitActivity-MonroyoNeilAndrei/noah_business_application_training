function func_Reload() {
    crLnk = GetCurrentURL() + "LMSMSMETagging_Gateway";
    crLnkGateKey = "LMSMSMETagging";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Do you want to save the current record?", "MSME Tagging", "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Do you want to delete the current record?", "MSME Tagging", "", indef, enume);
    isContinue = false;
    return isContinue;
}
