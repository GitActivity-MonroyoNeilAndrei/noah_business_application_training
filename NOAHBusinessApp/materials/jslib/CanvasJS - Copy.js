...
# Date Modified : January 7 2020 / 08:16 AM  - before: 12-29-2020
...
function _sfDefaultSettings() {
    return {
        ...
        , gridtype: "spread" // spread / grid / gridold
...
P8.SpreadSheet.prototype.RowHeight = function (r, data) {
    if (data == undefined) data = this.Data[r].aagrowHeight;
    else {
...
P8.SpreadSheet.prototype.ColumnWidth = function (c, data) {
    if (data == undefined) data = this.ColumnConfig[c].width;
    else {
...
P8.SpreadSheet.prototype.ColumnName = function (c, data) {
    if (data == undefined) data = this.ColumnConfig[c].ColumnName;
    else {
...
function _sfSetBorder(obj, c, r, data, tag) {
    ...
    var styleX = "solid";
    var colorX = "black";
    var arrStyle = ["solid", "dotted", "dashed"];
                    ...
                    setTimeout(function () {
                        try {
                            if (isValueChange) {
                                ...
                                try {
                                    p8Spread_Change(obj.canvasID, r, c);
                                } catch (err) { }
...
function _sfScrollUpdateSizing(containerID) {
    ...
    $(objScrolH).find('.P8Spread_ScrollBar').css('min-height', scrollDrag);
...
function canvasCreate(canvasID, obj) {
    ...
    if ($("#" + canvasID).index() >= 0) {
        ...
        x_html += "<canvas id='" + canvasID + "'  p8style='height:" + ($('#' + containerID).css("height")) + ";cursor:default;width:" + $('#' + containerID).css("width") + ";'></canvas>";
        x_html += "<canvas id='" + canvasID + "_temp'  p8style='display:none;height:" + ($('#' + containerID).css("height")) + ";cursor:default;width:" + $('#' + containerID).css("width") + ";'></canvas>";
        ...
        x_html += "<div  class='P8Spread_Scroll' p8style='padding:0px;min-width:100%;min-height:30px;background: #c7d4e1;border: 1px solid #80808085;'><div id='" + containerID + "_P8Spread_Scroll' class='P8Spread_ScrollBar Vr' p8style='min-height:30px;background: #83bbd8;border-radius: 3px;background-image: -webkit-linear-gradient(top, #83bbd8, #80a6b9);background-image: -moz-linear-gradient(top, #83bbd8, #80a6b9);background-image: -ms-linear-gradient(top, #83bbd8, #80a6b9);background-image: -webkit-gradient(linear, 0 0, 0 100%, from (#83bbd8), to(#80a6b9));background-image: -webkit-linear-gradient(top, #83bbd8, #80a6b9);background-image: -o-linear-gradient(top, #83bbd8, #80a6b9);background-image: linear-gradient(top, #83bbd8, #80a6b9);box-shadow: inset 1px 1px 5px #a9e6ff;border: 1px solid #32323259;'><div id='" + containerID + "_P8Spread_Scroll_handler' p8style='min-width:100%;min-height:100%'></div></div></div>"; //scrollbar
        ...
        x_html += "<div id='" + containerID + "H_P8Spread_ScrollLeft' class='P8Spread_ScrollLeft' p8style='padding: 0px;min-height: 15px;min-width: 15px;display: inline-block;background-color: #efefef;background-color: #83b8d3;border: 1px solid #607c8b;box-shadow: inset 0px 0px 5px #e5e5e5;border-radius: 3px;'></div>";
        x_html += "<div  class='P8Spread_ScrollH' p8style='padding:0px;min-width:30px;min-height:13px;background: #c7d4e1;display: inline-block;'><div id='" + containerID + "H_P8Spread_Scroll' class='P8Spread_ScrollBar Hr' p8style='padding: 0px;min-height: 13px;min-width: 30px;border: 1px solid #a1a1a1;box-shadow: inset 0 0 5px #bfbebe;border-radius: 2px;background-color: whitesmoke;'><div id='" + containerID + "_P8Spread_ScrollH_handler' class='P8Spread_ScrollH_handler' p8style='width: 30px;min-height: 13px;padding: 0px;position: relative;left: 0px;background: #83bbd8;border-radius: 3px;background-image: -webkit-linear-gradient(top, #83bbd8, #80a6b9);background-image: -moz-linear-gradient(top, #83bbd8, #80a6b9);background-image: -ms-linear-gradient(top, #83bbd8, #80a6b9);background-image: -webkit-gradient(linear, 0 0, 0 100%, from (#83bbd8), to(#80a6b9));background-image: -webkit-linear-gradient(top, #83bbd8, #80a6b9);background-image: -o-linear-gradient(top, #83bbd8, #80a6b9);background-image: linear-gradient(top, #83bbd8, #80a6b9);box-shadow: inset 1px 1px 5px #a9e6ff;border: 1px solid #32323259;'></div></div></div>"; //scrollbar
        x_html += "<div id='" + containerID + "H_P8Spread_ScrollRight' class='P8Spread_ScrollRight' p8style='padding: 0px;min-height: 15px;min-width: 15px;display: inline-block;background-color: #efefef;background-color: #83b8d3;border: 1px solid #607c8b;box-shadow: inset 0px 0px 5px #e5e5e5;border-radius: 3px;'></div>";
        ...
        $("#" + containerID + "_P8Spread_ScrollH_handler").draggable({
            ...
            , drag: function (e) {
                ...
                //updateCounterStatus($drag_counter, counts[1]);
                var scrollCount = 10;
                var rowcount = obj.ColumnConfig.length;
                ...
                if (obj.ColumnConfig.length < obj.startCol) {
                    return false;
                }
    ...
    var tlLetterHeight = 26;
    var sheetStart_y = tlLetterHeight;

    if (obj.HeaderGroup.length >= 1) {
        sheetStart_y += tlLetterHeight + borderMargin;
    }
    ...
    for (var ic = obj_startCol ; ic <= scolumn ; ic++) {
        ...
        if (obj.HeaderGroup.length >= 1) {
            ...
            if (isPart == false) {
                myCell.height = (tlLetterHeight - borderMargin) + (tlLetterHeight + borderMargin);
            }
            else {
    ...
    if (obj.havelistner == false) {
        ...
        canvasSheet.addEventListener('mouseup', function (event) {
            obj.CellSelHover = false;
            if (obj.IsResizeHover == true && obj.IsResizeClick == true) {
        ...
        function SpreadDBClick(event, iscustom) {
            ...
            if (iscustom == true) {
                try {
                    var xdata = p8Spread_DblClick(obj.canvasID, obj.CellSelected.row - 1, obj.CellSelected.col - 1);
            ...
            objx.forEach(function (element) {
                if (y > element.y && y < element.y + element.height && x > element.x && x < element.x + element.width) {
                    ...
                    try {
                        obj.IsResizeHover = false;
                        obj.CellSelHover = false;
                        p8Spread_Click(obj.canvasID, obj.CellSelected.row - 1, obj.CellSelected.col - 1);
        ...
        */
        ...
        cmpInput.onkeydown = function (e) {
            ...
            if (xy >= 1 && xy <= 4) {
                ...
                setTimeout(function () {
                    try {
                        p8Spread_Focus(obj.canvasID, obj.CellIndexes.Row, obj.CellIndexes.Col);
                    } catch (err) { }
    ...
    $('#' + containerID + "_vw_con").css("max-height", $('#' + containerID + "_vw").css("height"));
...
function _sfSelectionActivate(obj) {
    ...
    if ((ColumnTemplate + "").indexOf("nwDatePick") >= 0) {
        ...
        //$('.nwDatePickP8').datepicker({
        //});
        try { $('.nwDatePickP8').mask("99/99/9999"); } catch (err) { }
...
$(document).on("click", ".P8Spread .nwgrid_SaveWidth", function () {
    ...
    var nwsavecolumnID = spread.Book.Buttons[0]._ColumnWidthSaveID;
...
function p8SpreadResetColWith(ver) {
    ...
    for (xctr = 0; xctr < xcount; xctr++) {
        ...
        spread.ColumnWidth(xctr, parseInt(tempwidth));
    }
}
...
P8.SpreadSheet.prototype.GetBackground = function (c, r) {
    ...
    stringV = stringV.replace("!important", "");
