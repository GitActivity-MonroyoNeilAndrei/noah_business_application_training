...
{
    public class SBRequestForExtensionBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            //Addchars();
            dal = new SBRequestForExtensionDAL(this.UserDefinedConnectionString, based.SecurityAccess.ConnectionString, "");
        ...
        public void GenerateGrid(bool isInitialize)
        {
            ...
            grid.nwobject(SPR_ProjectName - 1).ColumnName("Project Name");
            ...
            grid.nwobject(SPR_Request - 1).ColumnName("Request for Extension");
            ...
            grid.nwobject(SPR_HoldingExpiryExt - 1).Width(150);
