...
//SPR_Addon_ItemGroupTypeDesc = 5,
//SPR_Addon_UOM = 6,
//SPR_Addon_Qty = 7,
//SPR_Addon_PricePerUnitUOM = 8,
//SPR_Addon_PriceVatIn = 9,
//SPR_Addon_PriceVatEx = 10,
//SPR_Addon_DiscountRate = 11,
//SPR_Addon_DiscountAmount = 12,
//SPR_Addon_NetAddonPriceVatIn = 13,
//SPR_Addon_NetAddonPriceVatEx = 14,
//SPR_Addon_CrossRefCode = 15,
...
function func_Reload() {
    crLnk = "../SPLTOEntry/SPLTOEntry_Gateway";
    crLnkGateKey = "SPLTOEntry";
    ...
    nwPopupForm_Create("nwAmortization", true);
...
function loadParameter_nwDocno() {
    nwdocno = getParameterByName("nwDocno");
    ...
    for (var z = 0; z < addtoListTableCount; z++) {
        ...
        if ((Level1x == '' || Level1x == undefined) && z == 0) {
            ...
            if (Level1 != Level1x || Level2 != Level2x || Level3 != Level3x || Level4 != Level4x) {
                MessageBox("Cannot Proceed. Selection of Multiple Section/Block is not allowed.", pagetitle);
                return;
            }
        }
    }
...
function Lookup_DoneFunction(idName, idNum) {
    ...
    if (idName == `lugBranchProject`) {
        ...
        //itemgrouptype_global = getGridData(idNum, 2);
        ////$('#txtItemGroupType').val(itemgrouptype_global);
        //itemgroup_global = getGridData(idNum, 4);
        ...
        //Whatever in the branch it should be the same in location with accountable forms.
        //$('#idvallugLocWithAccntblForms').val(getGridData(idNum, 0));
        //$('#descvallugLocWithAccntblForms').val(getGridData(idNum, 1));
        ...
        $('#ddtxtPhase').html('');
        //func_ActionDriven(`actPopulateBranchDropDown`, false);

        //GetStandardPrice();

        //if (getGridData(idNum, 6) == '0')
        //    MessageBox("Selected Location has no existing LTS No.", pagetitle);
    ...
    if (idName == 'lugClient') {
        ...
        ClearAllGrid();
        $('#txtLotPrice,#txtHousePrice,#txtSellingPrice,#txtVatAmount,#txtGrossSellingPrice,#txtMisc,#txtTCP,#txtSalesDiscountAmount,#txtNTCP').val('');
        $('#txtCustomer').val(getGridData(idNum, 1));
        ...
        //$('#ddtxtSourceOfSale').val(getGridData(idNum, 8));
        ...
        //$(`#idvallugSourceofSale`).val(getGridData(idNum, 8));
        //$(`#descvallugSourceofSale`).val(getGridData(idNum, 9));
    ...
    if (idName == 'lugUnitCode') {
        ...
        nwParameter_Add(`idvallugFinancingType`, $(`#idvallugFinancingType`).val());
        nwParameter_Add(`idvallugBranchProject`, $(`#idvallugBranchProject`).val());
        nwParameter_Add(`UnitCode`, getGridData(idNum, Cols.UnitCode));
        nwParameter_Add(`ddPhaseTower`, $('#ddPhaseTower option:selected').val());
    ...
    if (idName == 'lugFinancingType') {
        ...
        if (getGridData(idNum, Cols.FinancingTypeCode) == 'SPOT') {
            //$('#chkLumpSum').addClass('adisabled').enable(false);
            $('#ddSpotCashDiscount').removeClass('adisabled').enable(true);
        }
        else {
            //$('#chkLumpSum').removeClass('adisabled').enable(true);
    ...
    if (idName == 'lugAddonItem') {
        ...
        //nwLib.nwTempTable_RowData_Set("nwGridAddOn", crnwTR.index(), SPR_Addon_ItemGroupTypeDesc)(getGridData(idNum, 2));
        //nwLib.nwTempTable_RowData_Set("nwGridAddOn", crnwTR.index(), SPR_Addon_CategoryCode)(getGridData(idNum, 3));
        //nwLib.nwTempTable_RowData_Set("nwGridAddOn", crnwTR.index(), SPR_Addon_CrossRefCode)(getGridData(idNum, 5));
        //nwLib.nwTempTable_RowData_Set("nwGridAddOn", crnwTR.index(), SPR_Addon_Qty, `input`)(getGridData(idNum, 6));
        //nwLib.nwTempTable_RowData_Set("nwGridAddOn", crnwTR.index(), SPR_Addon_PricePerUnitUOM, `input`)(getGridData(idNum, 8));
        // Price VAT IN
        //var qty = (getGridData(idNum, 6));
        //var pricePerUnitUom = getGridData(idNum, 7);
        //ComputeAddOnPriceVatInAndVatExPerLine(qty, pricePerUnitUom);
    }
    /******************************* END HERE (Addon Tab) *************************************************/
    ...
    if (idName == `lugDiscount`) {
        ...
        //for spot only
        //if ($('#idvallugFinancingType').val() == 'SPOT' && parseFloat(getGridData(idNum, 3).replace(' %', '')) <= parseFloat($('#ddSpotCashDiscount option:selected').text().replace(' %', '')) || 0.00) {
        //    MessageBox("Cannot Proceed. Discount Rate should not be less than or equal to Spot Discount Rate.", pagetitle);
        //}
        //else {
        ...
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_DiscountCode)(getGridData(idNum, 0));
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_DiscountType)(getGridData(idNum, 1));
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_DiscountTypeCode)(getGridData(idNum, 2));
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_DiscountRate)(getGridData(idNum, 3));
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_Period)(getGridData(idNum, 4));
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_From)(getGridData(idNum, 5));
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_To)(getGridData(idNum, 6));
        //    nwLib.nwTempTable_RowData_Set("nwGridDiscount", crnwTR.index(), SPR_Discount_DiscountCriteria)(getGridData(idNum, 7));

        //    $('#txtSalesDiscountRate').val(getGridData(idNum, 3));
        ...
        //                rate = parseFloat(getGridData(idNum, 3).replace(' %', '')) || 0.00;
        ...
        //                //NTCP
        //                dpDiscAmt = parseFloat(getGridDataPerLine(`nwGridPaymentTermDetails`, `input`, SPR_PaymentTermDetails_DPDiscountAmount, i).split(`,`).join(``)) || 0.00;
        //                ntcp = tcp - dpDiscAmt;
    ...
    if (idName == 'lugPaymentTermGrouping') {
        ...
        //nwParameter_Add(`reservMisc`, reservMisc); pff
...
function DiscountComputation(rate, miscType) {
    ...
    setGridData(`nwGridDiscount`, ``, SPR_Discount_DiscountAmt, 0, nwCurrency(discAmount));
    setGridData(`nwGridDiscount`, ``, SPR_Discount_DiscountSP, 0, nwCurrency(discAmountSP));
    setGridData(`nwGridDiscount`, ``, SPR_Discount_DiscountMSC, 0, nwCurrency(discAmountMSC));
...
$(document).on('change', '#ddSpotCashDiscount', function (e) {
    if ($('#idvallugFinancingType').val().toUpperCase() == 'SPOT') {
        ...
        var spotdisc = parseFloat($('#ddSpotCashDiscount option:selected').val().replace(' %', '')) || 0.00;
        var spotamount = 0.00;
        if (spotdisc > 0) {
            spotamount = parseFloat($.grep(JSON.parse(jsonSpot), function (n, i) { return n.Code == spotdisc })[0].Amount) || 0.00;
...
function EnableFields() {
    ...
    $('#btnReqCompHDR').removeClass('btnOrange');
    $('#btnReqCompHDR').removeClass('btnGreen');

    $("#lugSrcOfAwareness").enable(true);
    $("#lugRsnForBuying").enable(true);
...
function DisableFields() {
    ...
    $('#txtFixedInterest').prop('disabld', true);
    $("#lugAgent").addClass('adisabled');
    $("#idvallugAgent").prop("disabled", true);
    ...
    $('#btnGenerate').removeClass('btnBlue');
    $('#btnApprovalDetails').enable(false);
    ...
    $("#lugSrcOfAwareness").enable(false);
    $("#lugRsnForBuying").enable(false);
}
...
function EnableFieldsDone() {//Binding Done
    ...
    //$('#lugAccountOfficer1').addClass('adisabled');
    //$('#idvallugAccountOfficer1').prop('disabled', true);

    //$('#lugAccountOfficer2').addClass('adisabled');
    //$('#idvallugAccountOfficer2').prop('disabled', true);

    //LoadCombo();
    fn_EnableDisabledSpotCash();
    //var finance_Code = $('#idvallugFinancingType').val();
    //if (finance_Code == 'SPOT') {
    //    $('#chkLumpSum').addClass('adisabled').enable(false);
    //}
    //else {
        $('#chkLumpSum').removeClass('adisabled').enable(true);
    //}
    //$('#ddtxtPhase').prop('disabled', false);
    //$('#ddtxtUnitType').prop('disabled', false);
    //$('#ddtxtUnitClass').prop('disabled', false);
    //$('#ddlNoOfUnits').prop('disabled', false);



    //var cnt = $('#nwGridPaymentTermDetailsCo tr').length-1;
    //for (i = 1; i < cnt; i++)
    //{
    //    
    //}

    //if (getGridData(idNum, 0).toString().toUpperCase() == `DOWNP`) {
    //    crnwTR.find("td:eq(" + SPR_PaymentTermDetails_DPDiscount + ") input").enable(true);
    //    crnwTR.find("td:eq(" + SPR_PaymentTermDetails_DPDiscount + ")").css('background-color', 'white');
    //}
    //else {
    //    crnwTR.find("td:eq(" + SPR_PaymentTermDetails_DPDiscount + ") input").enable(false);
    //    crnwTR.find("td:eq(" + SPR_PaymentTermDetails_DPDiscount + ")").css('background-color', 'gainsboro');
    //}
    //console.log($('#txtIsVatable').val());
    //EnableDisabledInsuranceTab(false);
    ...
    if (tag == 0) {
        ...
        if (jsonMisc.length > 0) {
            if (jsonMisc[0].MiscellaneousAmount != '') {
                parent_MessageBoxQuestion("Miscellaneous will be lost. Would you like to continue?", pagetitle, "Question");
        ...
        parent_MessageBoxQuestion("Line Details will be lost. Would you like to continue?", pagetitle, "Question");
        $('.message_Cancel').css('display', 'none');
        $('#dimMessageBox .BoxClose').css('display', 'none');
    }
    else if (tag == 2) {
        ...
        if (dpdiscAmt > 0 && rate > 0) {
            parent_MessageBoxQuestion("DP Discount will be lost. Would you like to continue?", pagetitle, "Question");
            $('.message_Cancel').css('display', 'none');
            $('#dimMessageBox .BoxClose').css('display', 'none');
        } else {
            doDiscountCompute();
...
function nwGrdi_DblClick(nwobj, nwobjrow, nwobjitem) {
    ...
    if (nwobjID == `nwGridUnitDetails`) {
        ...
        var errorResult = ''
        if (Loc == '')
            errorResult += 'Cannot Proceed. Location with Accountable Forms is required. \n';

        if (Branch == '')
            errorResult += 'Cannot Proceed. Project is required. \n';

        //if (InventoryGroup == '')
        //    errorResult += 'Cannot Proceed. Inventory Group is required. \n';

        if (ProductType == '')
            errorResult += 'Cannot Proceed. Product Type is required. \n';

        if (Phase == '')
            errorResult += 'Cannot Proceed. Phase/Tower is required. \n';

        if (Category == '')
            errorResult += 'Cannot Proceed. Category is required. \n';

        if (FinancingType == '')
            errorResult += 'Cannot Proceed. Financing Type is required. \n';
        ...
        //    errorResult += 'Cannot Proceed. Location with Accountable Forms is required. \n';
        //if (Branch == '')
        //    errorResult += 'Cannot Proceed. Branch is required. \n';
        //if (Phase == '')
        //    errorResult += 'Cannot Proceed. Phase/Tower is required. \n';
        //if (FinancingType == '')
        //    errorResult += 'Cannot Proceed. Financing Type is required. \n';
        //if (Unittype == '')
        //    errorResult += 'Cannot Proceed. Unit Type is required. \n';
        //if (UnitClass == '')
        //    errorResult += 'Cannot Proceed. Unit Class is required. \n';
        ////if (NoOfUnits == '')
        ////    errorResult += 'Cannot Proceed. No. of Units is required. \n';
        //if (Client == '')
        //    errorresult += 'cannot proceed. Client is required. \n';
...
function func_LookUpInitialize(dimP) {
    ...
    if (dimP != "lugClient") {
        ...
        $('.lugClient div:eq(1)').append("<button id='btnCreateCustomer'>Create Customer</button>");
    }
...
//$(document).on(`change`, `#txtDPStartDate`, function () {
//    if ($(`#txtDPStartDate`).val().length > 0) {
//        nwParameter_Add(`txtReservationDate`, $('#txtReservationDate').val());
...
//        var totalNoOfPayments = 0;
//        for (i = 0; i < count; i++) {
//            paymentCat = $('#nwGridPaymentTermDetails-nwData tr:eq(' + i + ') td:eq(' + SPR_PaymentTermDetails_PaymentCategory + ') option:selected').val()||'';

//            if (paymentCat.toUpperCase() == 'DOWNP') {
//                totalNoOfPayments += (parseFloat(getGridDataPerLine(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_NoOfPayments, i).split(`,`).join(``))) || 0.00;
//            }
//            else if (paymentCat.toUpperCase() == 'SPOT') {
//                totalNoOfPayments += (parseFloat(getGridDataPerLine(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_NoOfPayments, i).split(`,`).join(``))) || 0.00;
//            }
//        }
//        if ($('#idvallugFinancingType').val() == 'SPOT') {
//            if ($(this).val().length > 0)
//                $('#txtBalStartDate').val(formatDate(getEndDate(new Date($(this).val()), totalNoOfPayments)));
//            else
//                $('#txtBalStartDate').val('');
//        }
//        else {
...
//            nwParameter_Add(`TotalNoOfPayments`, totalNoOfPayments);
//            func_ActionDriven(`actPopulateDownpayment`, false);
//        }

//        //formatDate(addMonths(new Date(dpdate), ctr))
//        //if()
...
$(document).on(`click`, `#btnExportPrint`, function (e) {
    nwLoading_Start("actExportAmort", crLoadingHTML);
    var jsonPrintingHDR = [];
    var z = {};
    z["Company"] = $('#AmortCompany').text();
    z["ReservationDate"] = $('#lblReservationDate').text();
    z["RegisteredName"] = $('#lblRegisteredName').text();
    z["UnitCode"] = $('#lblUnitCode').text();
    z["UnitType"] = $('#lblUnitType').text();
    z["UnitClass"] = $('#lblUnitClass').text();
    z["LotArea"] = $('#lblLotArea').text();
    z["SellingPrice"] = $('#lblSellingPrice').text();
    z["Vat"] = $('#lblVat').text();
    z["GrossSellingPrice"] = $('#lblGrossSellingPrice').text();
    z["Misc"] = $('#lblMisc').text();
    z["TCP"] = $('#lblTCP').text();
    z["SalesDisc"] = $('#lblSalesDisc').text();
    z["DPDisc"] = $('#lblDPDisc').text();
    z["NetContractPrice"] = $('#lblNetContractPrice').text();
    z["FinancingType"] = $('#lblFinancingType').text();
    jsonPrintingHDR.push(z);

    nwParameter_Add('jsonTermDetails', html2json('nwGridTermDetails'));
    nwParameter_Add('jsonAmort', html2json('nwGridAmortization'));
...
$(document).on('click', '#btnOtherStatement', function (e) {
    ...
    if ($(`#ddtxtInsuranceCompany option:selected`).val().length > 0) {
        nwLoading_Start("actStatementDetails", crLoadingHTML);
        ...
        MessageBox("Cannot Proceed. Insurance Company is required.", pagetitle);
    return false;
})
...
$(document).on('click', '#btnSaveStatementDetails', function () {
    nwLoading_Start("actSavingStatementDetails", crLoadingHTML);
...
$(document).on('change blur', '#ddtxtInsuranceCompany', function () {
    if (dtStatementDetails.length > 0) {
        ...
        parent_MessageBoxQuestion("Other Statement detail will be lost. Would you like to continue?", pagetitle, "Question");
        $('.message_Cancel').css('display', 'none')
        $('#dimMessageBox .BoxClose').css('display', 'none');
    }
    return false;
...
$(document).on('click', '#btnReservationDoc', function (e) {
    ...
    if (refTranNo == '')
        errorResult += 'Cannot Proceed. Reservation Control No. is required. \n';
    if (clientName == '')
        errorResult += 'Cannot Proceed. Client is required. \n';
...
$(document).on('change blur', '#ddBranchID', function (e) {
    if ($(this).val().length > 0) {
        ResetGrid(`nwGridMiscDetailsCon`);
        nwLoading_Start("actPopulateDefaultMCF", crLoadingHTML);
...
function MiscellaneousDetails(){
    $('#custom1').remove();
    $('#nwGridPaymentTermDetails .nwgridButtons').append("<div class='nwgrid_buttonsCon' id='custom'><button id='btnPaymentTermGroup'>SELECT PAYMENT TERM GROUP</button></div>");
    $('#nwGridPaymentTermDetails .nwgridButtons').append("<div class='nwgrid_buttonsCon' id='custom'><button id='btnMiscellaneousDetails'>MISCELLANEOUS DETAILS</button></div>");
...
function LoadCoBuyerDetails() {
    $('#custom2').remove();
    $('#nwGridCoBuyer .nwgridButtons').append("<div class='nwgrid_buttonsCon' id='custom2'><button id='btnLoadCoBuyerDetails'>LOAD CO-BUYER DETAILS</button></div>");
    $('#btnLoadCoBuyerDetails').enable(false);
...
$(document).on(`click`, `#btnGenerate`, function () {
    ...
    var lotaArea = getGridDataPerLine(`nwGridUnitDetails`, ``, SPR_UnitDetails_LotArea, 0) + '/' + getGridDataPerLine(`nwGridUnitDetails`, ``, SPR_UnitDetails_FloorArea, 0);
    ...
    //nwParameter_Add('DeductedTotalSellingPrice', parseFloat($('#txtTotalSellingPrice').val().split(',').join('') - $o().sumTotalDiscountSP()));
        ...
        if (paymentCategory != '' && paymentCategory != undefined) {
            if (i != crnwTR.index()) {
                if (paymentCategory == val
                    ...
                    errorResult += 'Cannot Insert. Duplicate Payment Category. \n';
                }

                if (i > crnwTR.index() && paymentCategory == val && paymentCategory == 'DOWNP') {
                    errorResult += 'Cannot Continue. Insert below downpayment. \n';
                }
            }
        }
    }
...
$(document).on('click', '#btnSaveMiscellaneous', function () {
    ...
    $('#nwGridMiscellaneousFee-nwData tr').each(function (i, n) {
        ...
        totalMiscellaneousAmount += parseFloat($row.find('td:eq(' + SPR_MISCELLANEOUSAMOUNT + ') input').val().replace(',', ''));
        if (MiscellaneousType != '' ||
            ...
            if (MiscellaneousType == '') {
                errorResult += 'Cannot Save. Miscellaneous Type is required at row ' + ctr + '. \n';
            }

            if (AllocationType == '') {
                errorResult += 'Cannot Save. Allocation Type is required at row ' + ctr + '. \n';
            }

            if (PaymentCategory == '') {
                errorResult += 'Cannot Save. Payment Category is required at row ' + ctr + '. \n';
            }

            if (MiscellaneousDate == '') {
                errorResult += 'Cannot Save. Miscellaneous Date is required at row ' + ctr + '. \n';
            }

            if (MiscellaneousAmount <= 0) {
                errorResult += 'Cannot Save. Miscellaneous Amount is required at row ' + ctr + '. \n';
            }
        }
        ctr++;
    });
    ...
    if (parseFloat($('#txtMiscAmt').val().split(',').join('')) != parseFloat(totalMiscellaneousAmount).toFixed(2)) {
        errorResult += 'Cannot Save. Miscellaneous Amount should be equal to the Total Miscellaneous Amount. \n';
    }
    ...
    if (errorResult != '') {
        ...
        //SaveJSON();
        $fn().saveJSON();
        MessageBox("Saved successfully.", pagetitle);
        $('#nwMisc .BoxClose').click();
    }
...
//    var dpRate = $('#txtDPRate').val();
//    var vatRate = $('#txtVatrate').val();
//    var reserv = parseFloat($('#txtReservationAmount').val().split(',').join(''))||0.00;
//    var miscRate = $('#txtRate').val();
//    var miscAmt = parseFloat($('#txtMiscAmt').val().split(',').join(''));
//    var isReserv = $('select.clsCategory').map(function () { return this.value }).get().filter(cra=>cra == 'RESRV').length > 0;
//    var isDownp = $('select.clsCategory').map(function () { return this.value }).get().filter(cra=>cra == 'DOWNP').length > 0;
...
//        if (category == 'RESRV')
//            misc = ((reserv / (1 + (vatRate / 100) + (miscRate / 100))) * (miscRate / 100));
//        else if (category == 'DOWNP') {
//            if (ctr == 1)//1st DP
//                misc = ((miscAmt * (dpRate / 100)) - (isReserv ? ((reserv / (1 + (vatRate / 100) + (miscRate / 100))) * (miscRate / 100)) : 0));
//            else
//                misc = (miscAmt * (dpRate / 100));
//        }
//        else if (category == 'BALANC')
//            misc = miscAmt - ((isReserv ? ((reserv / (1 + (vatRate / 100) + (miscRate / 100))) * (miscRate / 100)) : 0) + (isDownp ? ((miscAmt * (dpRate / 100)) - (isReserv ? ((reserv / (1 + (vatRate / 100) + (miscRate / 100))) * (miscRate / 100)) : 0)) : 0));
...
function LoadDefaultPaymentTermGrouping(dt, dtWithSalesDisc) {
    ClearFields(2);

    //pff from mvpi
    var objSalesDisc = JSON.parse(dtWithSalesDisc);
    if (objSalesDisc.length > 0) {
        setGridData(`nwGridDiscount`, ``, SPR_Discount_DiscountCode, 0, objSalesDisc[0].DiscountCode);
        setGridData(`nwGridDiscount`, ``, SPR_Discount_DiscountType, 0, objSalesDisc[0].DiscountTypeDesc);
        setGridData(`nwGridDiscount`, `input`, SPR_Discount_DiscountRate, 0, objSalesDisc[0].DiscountRate);

        $('#nwGridDiscount-nwData tr:eq(0) td:eq(' + SPR_Discount_BasisOfDiscount + ') select').val(objSalesDisc[0].BasisOfDiscount);
        $('#nwGridDiscount-nwData tr:eq(0) td:eq(' + SPR_Discount_DiscountApp + ') select').val(objSalesDisc[0].DiscountApplication);
    }
    //end pff
    ...
    if (dt != null || dt.length > 0) {
        ...
        for (i = 0; i < objtext.length; i++) {
            ...
            setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_PaymentTermCode, i, term.Code == null ? '' : term.Code);
            setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_PaymentTermDesc, i, term.Description == null ? '' : term.Description);
            setGridData(`nwGridPaymentTermDetails`, `input`, SPR_PaymentTermDetails_ContractRate, i, parseFloat(term.ContractRate) || 0.00);//LUA
            setGridData(`nwGridPaymentTermDetails`, `input`, SPR_PaymentTermDetails_TermAmount, i, nwCurrency(parseFloat(term.TermAmount) || 0.00));
            setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_MiscInstallment, i, nwCurrency(parseFloat(term.Misc) || 0.00));
            setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_ContractAmount, i, nwCurrency(parseFloat(term.ContractAmount) || 0.00));
            setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_SalesDiscount, i, nwCurrency(parseFloat(term.SalesDiscount) || 0.00));
            ...
            var financingType = $('#idvallugFinancingType').val();
            if (term.PaymentCategory == 'DOWNP') {
                monthlyWithoutMisc = (parseFloat(term.TermAmount) - term.DPDiscAmount) / term.TotalNoPayments;
            }
            else if (term.PaymentCategory == 'BALANC') {
                if (financingType == 'SPOT' || financingType == 'BNK' || financingType == 'PIF') {
                    monthlyWithoutMisc = (parseFloat(term.TermAmount));
    ...
    for (i = 0; i < cnt; i++) {
        if (i != 0) {//not include first in payment term details
            ...
            z = new ComputeGrid(
                     ...
                     category=='RESRV'?(jsonMisc.filter(x=>x.PaymentCategory=='RESRV').length>0?parseFloat(jsonMisc.filter(x=>x.PaymentCategory=='RESRV')[0].MiscellaneousAmount):0):0,
...
function doCompute(disctag) {
    ...
    //new
    $('#txtDiscountNew').val(nwCurrency(z.discountNew));
    $('#txtNetListPriceNew').val(nwCurrency(z.netListPriceNew))
    $('#txtVatAmountNew').val(nwCurrency(z.vatNew));
    $('#txtContractPriceNew').val(nwCurrency(z.contractPriceNew));
    $('#txtClosingFeesNew').val(nwCurrency(z.closingFeesNew));
    $('#txtTotalContractPriceNew').val(nwCurrency(z.tcpNew));
}
...
function SumAllHeader() {
    ...
    setGridData(`nwGridPaymentTermDetails`, `input`, SPR_PaymentTermDetails_ContractRate, 0, contractRate);
...
function $fn() {
    let $fn = {
        header: {
            ...
            //new
            discountNew: $('#txtDiscountNew'),
            netListPriceNew: $('#txtNetListPriceNew'),
            vatAmountNew: $('#txtVatAmountNew'),
            contractPriceNew: $('#txtContractPriceNew'),
            vatNew: $('#txtVatAmountNew'),
            closingFeesNew: $('#txtClosingFeesNew'),
            tcpNew: $('#txtTotalContractPriceNew')
        },
        grid: {
        ...
        //DPDiscount
        MultipleComputeDiscRate: function () {
            ...
            let dpDiscAmount = 0.00;
            $.each(elem, function (idx, obj) {
                ordering = $fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_Ordering})`).text();
                category = $fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_PaymentCategory}) option:selected`).val();
                val = $fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_DPDiscountRate}) input`).val() || 0;
                if (val > 0) {
                    if (category == 'DOWNP') {
                        if (discountBasis == '1') {
                            if (ordering == 1)
                                dpContractAmount = (parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_ContractAmount})`).text().split(',').join('')) || 0) + $fn.contractAmountReserv();
                            else
                                dpContractAmount = (parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_ContractAmount})`).text().split(',').join('')) || 0)
                        }
                        else {
                            if (ordering == 1)
                                dpContractAmount = (parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_TermAmount}) input`).val().split(',').join('')) || 0) + $fn.contractAmountReserv();
                            else
                                dpContractAmount = (parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_TermAmount}) input`).val().split(',').join('')) || 0)
                        }

                        salesDisc = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_SalesDiscount})`).text().split(',').join('')) || 0;

                        dpDiscAmount = ((val / 100) * (dpContractAmount - salesDisc)).toFixed(2);
                        $fn.setGridData(`nwGridPaymentTermDetails`, `input`, SPR_PaymentTermDetails_DPDiscountAmount, idx, nwCurrency(dpDiscAmount));

                        $fn.MultipleComputeNTCPAfterDPDisc(idx);
                        $fn.doCompute();
                        $fn.MultipleComputationDPMonthly(idx);

                        $fn.setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_DPDiscPrin, idx, nwCurrency($fn.MultipleDpDiscAllocationPerLine(idx).prinAllocVatEx));
                        $fn.setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_DPDiscMisc, idx, nwCurrency($fn.MultipleDpDiscAllocationPerLine(idx).miscAllocVatEx));
                    }
                }
            });
        },

        MultipleComputeNTCPAfterDPDisc: function (idx) {
            let salesDisc = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_SalesDiscount})`).text().split(',').join('')) || 0;
            let dpDiscAmount = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_DPDiscountAmount}) input`).val().split(',').join('')) || 0;
            let contractAmount = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_ContractAmount})`).text().split(',').join('')) || 0;
            let netContractPrice = contractAmount - salesDisc - dpDiscAmount;
            $fn.setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_NetContractPrice, idx, nwCurrency(netContractPrice));
        },


        MultipleComputationDPMonthly: function (idx) {
            let misctype = $fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_MiscellaneousType})`).text();
            let termAmount = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_TermAmount}) input`).val().split(',').join('')) || 0;
            let netContractPrice = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_NetContractPrice})`).text().split(',').join('')) || 0;
            let noOfPayments = parseInt($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_NoOfPayments})`).text().split(',').join('')) || 0;
            let contractRate = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_ContractRate}) input`).val().split(',').join('')) || 0;
            let ordering = $fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_Ordering})`).text();
            ...
            $fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_MonthlyPayment})`).text(nwCurrency(pmt));
            $fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_MonthlyPaymentWithoutMisc})`).text(nwCurrency(monthlywithoutmisc));

        },

        MultipleDpDiscAllocationPerLine: function (idx) {//vatex Allocation
            let result = [];
            let tcp = parseFloat($fn.header.tcp.val().split(',').join('')) || 0;
            let misc = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_MiscInstallment}) `).text().split(',').join('')) || 0;
            let gross = parseFloat($fn.header.grossSellingPrice.val().split(',').join('')) || 0;
            let discAmt = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(${idx}) td:eq(${SPR_PaymentTermDetails_DPDiscountAmount}) input`).val().split(',').join('')) || 0;
            let sp = parseFloat($fn.grid.discount.find(`.tblGridBody tr:eq(${0}) td:eq(${SPR_Discount_DiscountSP})`).text().split(',').join('')) || 0;
            let totalSalesDisc = parseFloat($fn.header.salesDiscAmt.val().split(',').join('')) || 0;
        ...
        doCompute: function () {
            ...
            let dpDiscount = parseFloat($fn.grid.paymentTermdetails.find(`.tblGridBody tr:eq(0) td:eq(${SPR_PaymentTermDetails_DPDiscountAmount}) input`).val().split(',').join('')) || 0;
            let netContractPrice = totalContractPrice - (salesDiscountAmount + dpDiscount);

            let discountNew = ($fn.getDiscountSP() + $fn.getDPDiscountSP()) || 0;
            let netListPriceNew = (parseFloat($fn.header.sellingPrice.val().split(',').join('')) || 0) - discountNew;
            //let contractPriceNew = grossSellingPrice - discountNew;
            let closingFeesNew = miscInstallment - ($fn.getDiscountMisc() + $fn.getDPDiscountMisc());
            let contractPriceNew = netContractPrice - closingFeesNew;
            let vatNew = contractPriceNew - netListPriceNew;//(parseFloat($fn.header.sellingPrice.val().split(',').join('')) || 0);
            let tcpNew = closingFeesNew + contractPriceNew;
            ...
            $fn.header.discountNew.val(nwCurrency(discountNew));
            $fn.header.netListPriceNew.val(nwCurrency(netListPriceNew));
            $fn.header.contractPriceNew.val(nwCurrency(contractPriceNew));
            $fn.header.vatNew.val(nwCurrency(vatNew));
            $fn.header.closingFeesNew.val(nwCurrency(closingFeesNew));
            $fn.header.tcpNew.val(nwCurrency(tcpNew));
        },
        ...
        sumAllHeader() {
            ...
            $.each(elem, function (idx, obj) {
                ...
                netContractPrice += parseFloat($(this).find('td:eq(' + SPR_PaymentTermDetails_NetContractPrice + ') ').text().split(',').join('')) || 0.00;
                noofPayment += parseFloat($(this).find('td:eq(' + SPR_PaymentTermDetails_NoOfPayments + ') ').text().split(',').join('')) || 0;
                dpdiscPrin += parseFloat($(this).find('td:eq(' + SPR_PaymentTermDetails_DPDiscPrin + ') ').text().split(',').join('')) || 0;
                dpdiscMisc += parseFloat($(this).find('td:eq(' + SPR_PaymentTermDetails_DPDiscMisc + ') ').text().split(',').join('')) || 0;
            });

            $fn.setGridData(`nwGridPaymentTermDetails`, `input`, SPR_PaymentTermDetails_ContractRate, 0, contractRate);//LUA
            ...
            $fn.setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_DPDiscPrin, 0, dpdiscPrin);
            $fn.setGridData(`nwGridPaymentTermDetails`, ``, SPR_PaymentTermDetails_DPDiscMisc, 0, dpdiscMisc);
        },
        ...
        reCompute: function (paymentCategory, grossSellingPrice, contractRate, misc, tag, ctr, termAmount, salesDiscount, dpDiscountAmount, financingType, noOfPayments, interest, amt, misctype, discAmountSP, discAmountMSC) {
            ...
            if (paymentCategory != 'SPOT') {
                if (paymentCategory == 'RESRV')
                    ...
                    //obj.salesDiscount = parseFloat((((discAmountSP * (1 + (vatrate / 100))) * (parseFloat(((obj.termAmount + reservSP) / grossSellingPrice)) || 0)) + (discAmountMSC * (parseFloat(((obj.misc + reservMisc) / misc)) || 0)))) || 0;
                    //obj.salesDiscount = (obj.contractAmount + contractAmount) * ((parseFloat(getGridDataPerLine(`nwGridDiscount`, `input`, SPR_Discount_DiscountRate, 0).split(`,`).join(``)) || 0.00) / 100);
                    if (ctr === dpCtr && balCtr <= 0) {
                        let downpaymentSalesDisc = 0.00;
                        $('#nwGridPaymentTermDetailsData tr:gt(1)').each(function (i, x) {
                            if ($(this).find('td:eq(' + SPR_PaymentTermDetails_PaymentCategory + ') option:selected').val() != 'BALANC') {
                                downpaymentSalesDisc += parseFloat($(this).find('td:eq(' + SPR_PaymentTermDetails_SalesDiscount + ')').text().split(',').join('')) || 0.00;
            ...
            obj.salesDiscount = Math.round(Number((Math.abs(obj.salesDiscount) * 100).toPrecision(15))) / 100 * Math.sign(obj.salesDiscount)
            obj.dpDiscountAmount = dpDiscountAmount;
            obj.netContractPrice = obj.contractAmount - obj.salesDiscount - obj.dpDiscountAmount;
        ...
        html2json: function (id) {
            ...
            if (id == 'nwGridMiscellaneousFee') {
                ...
                //rows = Object.values(rows).reduce(function (output, obj) {

                //    var objForId = output.filter(function (idObj) { return idObj.paymentCategory == obj.paymentCategory && idObj.ordering == obj.ordering })[0];

                //    if (objForId) {
                //        objForId.MiscellaneousAmount += obj.MiscellaneousAmount;
                //    } else {
                //        output.push({
                //            MiscellaneousType: obj.MiscellaneousType,
                //            AllocationType: obj.AllocationType,
                //            PaymentCategory: obj.PaymentCategory,
                //            MiscellaneousDate: obj.MiscellaneousDate,
                //            MiscellaneousAmount: obj.MiscellaneousAmount,
                ...
                var rows = rows.reduce((final, data) => {
                    let isAlready = final.find((value) => {
                        return value.Ordering == data.Ordering && value.PaymentCategory == data.PaymentCategory
                    });
                    if (!isAlready) {
                        final.push(data);
                    } else {
                        var index = final.indexOf(isAlready);
                        final[index].MiscellaneousAmount = parseFloat(final[index].MiscellaneousAmount) + parseFloat(data.MiscellaneousAmount);
                    }
                    return final;
                }, [])
            }
        ...
        getDiscountSP: () =>$fn.parseNumeric($fn.grid.discount.find(`.tblGridBody tr:eq(0) td:eq(${SPR_Discount_DiscountSP})`).text()),
        getDiscountMisc: () =>$fn.parseNumeric($fn.grid.discount.find(`.tblGridBody tr:eq(0) td:eq(${SPR_Discount_DiscountMSC})`).text()),
        getDPDiscountSP: () => {
            let dpDiscount = 0.00;
            $('#nwGridPaymentTermDetailsData tr:gt(1)').each(function (i, x) {
                if ($(this).find('td:eq(' + SPR_PaymentTermDetails_PaymentCategory + ') option:selected').val() == 'DOWNP') {
                    dpDiscount += parseFloat($(this).find('td:eq(' + SPR_PaymentTermDetails_DPDiscPrin + ')').text().split(',').join('')) || 0.00;
                }
            });
            return dpDiscount;
        },
        ...
        getDPDiscountMisc: () => {
            ...
            $('#nwGridPaymentTermDetailsData tr:gt(1)').each(function (i, x) {
                if ($(this).find('td:eq(' + SPR_PaymentTermDetails_PaymentCategory + ') option:selected').val() == 'DOWNP') {
                    dpDiscount += parseFloat($(this).find('td:eq(' + SPR_PaymentTermDetails_DPDiscMisc + ')').text().split(',').join('')) || 0.00;
                }
            });
            return dpDiscount;
        },
        ...
        computeHeader: () => {
            ...
            obj.sellingPrice = $fn.parseNumeric($fn.header.sellingPrice.val()) || 0;
            ...
            obj.discountNew = ($fn.getDiscountSP() + $fn.getDPDiscountSP()) || 0;// $('#txtDiscountNew'),
            obj.netListPriceNew = obj.sellingPrice - obj.discountNew;
            //obj.contractPriceNew = obj.grossSellingPrice - obj.discountNew;

            obj.closingFeesNew = obj.miscInstallment - ($fn.getDiscountMisc() + $fn.getDPDiscountMisc());
            obj.contractPriceNew = obj.netContractPrice - obj.closingFeesNew;
            obj.vatNew = obj.contractPriceNew - obj.netListPriceNew;
            obj.tcpNew = obj.closingFeesNew + obj.contractPriceNew;
        ...
        reComputeHdr: () => {
            ...
            $fn.header.discountNew.val($fn.comma(z.discountNew.toFixed(2)));
            $fn.header.netListPriceNew.val($fn.comma(z.netListPriceNew.toFixed(2)));
            $fn.header.contractPriceNew.val($fn.comma(z.contractPriceNew.toFixed(2)));
            $fn.header.vatNew.val($fn.comma(z.vatNew.toFixed(2)));
            $fn.header.closingFeesNew.val($fn.comma(z.closingFeesNew.toFixed(2)));
            $fn.header.tcpNew.val($fn.comma(z.tcpNew.toFixed(2)));
...
//function afterPercentageChange(json) {
//    let x = $fn().line.appGrid;
//    if (json.length > 0) {
//        $.each(Object.values(json), function (ctr, val) {
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_Pmt})`).text(val['pmt_app']);
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_MonthlyAmort})`).text(val['monthlyamort_app']);
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_MonthlyMiscellaneous})`).text(val['monthlymisc_app']);
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_Principal}) input`).val(val['prin_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_VatPrincipal}) input`).val(val['vatprin_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_Penalty}) input`).val(val['pen_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_VatPenalty}) input`).val(val['vatpen_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_Interest}) input`).val(val['int_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_VatInterest}) input`).val(val['vatint_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_InterestMisc}) input`).val(val['intmisc_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_VatInterestMisc}) input`).val(val['vatintmisc_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_Misc}) input`).val(val['misc_app']).loadCurrency();
//            x.find(`.tblGridBody tr:eq(${globalIndex}) td:eq(${SPR_App_VatMisc}) input`).val(val['vatmisc_app']).loadCurrency();
//        });
//    }
//}
