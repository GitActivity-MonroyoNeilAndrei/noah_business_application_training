...
{
    public class PMOOtherRequestDAL : NoahWebLib.DatabaseHandler
    {
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public PMOOtherRequestDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
