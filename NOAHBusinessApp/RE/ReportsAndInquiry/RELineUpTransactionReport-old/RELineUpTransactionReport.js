...
function func_Reload() {
    LoadStringsCases();
    crLnk = "RELineUpTransactionReport/RELineUpTransactionReport_Gateway";
    crLnkGateKey = "RELineUpTransactionReport";
    ...
    //for pop up
    docno = getParameterByName("nwDocno");
    nwParameter_Add("nwDocno", docno);
    if (docno != "") {
        $('#noah-webui-Toolbox').visible(docno);
        Refresh();
    }
...
function GenerateGrid(json) {  //sa Line to 
    $("#nwGridMainCon").html("")
    //header
    ...
    */
    //*Sales Call Report
      $("#nwGridMainCon").append("<tr><th><div class='col0'></th><th><div class='col1'>Seller Role</th><th><div class='col2'>Seller Name</th><th><div class='col3'>Prospect Customer</th><th><div class='col4'>Type</th><th><div class='col5'>Location</th><th><div class='col6'>Project</th><th><div class='col7'>Tower/Phase</th><th><div class='col8'>Mobile Number</th><th><div class='col9'>Email Address</th><th><div class='col10'>Start Date Time</th><th><div class='col11'>End Date Time</th><th><div class='col12'>Notification Schedule</th><th><div class='col13'>Notification Number</th><th><div class='col14'>Remarks</th><th><div class='col15'>Record Status</th></tr>");
    //*Transaction Log Report
      $("#nwGridMainCon").append("<tr><th><div class='col0'></th><th><div class='col1'>Seller Role</th><th><div class='col2'>Seller Name</th><th><div class='col3'>Transaction Type</th><th><div class='col4'>Transaction No</th><th><div class='col5'>Transaction Date</th><th><div class='col6'>Transaction Explation Date</th><th><div class='col7'>Holding Expiry Date (extended)</th><th><div class='col8'>Customer</th><th><div class='col9'>Customer Classification</th><th><div class='col10'>Project</th><th><div class='col11'>Unit Code</th><th><div class='col12'>Unit Description</th><th><div class='col13'>Total Contact</th><th><div class='col14'>Price</th><th><div class='col15'>Source of Sale</th><th><div class='col15'>Transaction Approval Date</th><th><div class='col17'>Approved By</th><th><div class='col18'>Approval History</th><th><div class='col19'>Current Transaction Status</th></tr>");
}
...
$(document).on('click', '.btnHist', function () {
    ...
    $('#iframeBtnMaximize').hide()
    //title = crnwTR.find("td:eq(" + SPR_Project + ")").text();
    crntRow = this.parentNode.rowIndex;;
    //var nwDocno = $('#nwGridMainCon tbody tr:eq(' + crntRow + ') td:eq(' + (SPR_TransactionNo - 1) + ')').text();
    docno = $('#nwGridMainCon tbody tr:eq(' + crntRow + ') td:eq(' + (SPR_TransactionNo - 1) + ')').text();
    var trantype = $('#nwGridMainCon tbody tr:eq(' + crntRow + ') td:eq(' + (SPR_TranType - 1) + ')').text();
    //$('#txtTransactionNo').val(nwDocno
    ...
    //if (title.length > 0) {
    //    fulllength = crnwTR.find("td.eq(" + SPR_Project + ")".text() + encodeURI(nwDocno));
    //    nwPopupForm_Create("nwPopupWindow", true, fulllength)
    //    $('#nwPopupWindow .BoxTitle').text(title);
...
//function activeRadioTab(){
//    $('[name=selReport]').each(function (x) {
...
//    $('[name=selReport]').on('change', function () {
//        var z = $(this).prop('checked');

//        // $(type).index(this) == nth-of-type
//        var x = $('[name=selReport]').index(this);

//        $('.displayGrid').removeClass('on');
//        $('.displayGrid').eq(x).addClass('on');
//    });
