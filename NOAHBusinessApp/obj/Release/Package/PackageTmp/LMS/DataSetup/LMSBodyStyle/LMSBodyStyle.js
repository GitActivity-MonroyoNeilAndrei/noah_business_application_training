function func_Reload() {
    crLnk = GetCurrentURL() + "LMSBodyStyle_Gateway";
    crLnkGateKey = "LMSBodyStyle";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Would you like to save the current record?", "Body Style", "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Would you like to delete the current record?", "Body Style", "", indef, enume);
    isContinue = false;
    return isContinue;
}
