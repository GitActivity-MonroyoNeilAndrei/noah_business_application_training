...
{
    public class SAUserAccessLogController : nwStandardGateway
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(@"~\SA\ReportsAndInquiry\SAUserAccessLog\SAUserAccessLog.cshtml");

        }


        public ActionResult SAUserAccessLog_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    SAUserAccessLogBL menuBL = new SAUserAccessLogBL();
