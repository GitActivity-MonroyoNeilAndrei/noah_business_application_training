...
{
    public class SBMyProspectCustomers_SendLinkBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            //Addchars();
            dal = new SBMyProspectCustomers_SendLinkDAL(this.UserDefinedConnectionString, based.SecurityAccess.ConnectionString, "");
        ...
        SBMyProspectCustomers_SendLinkDAL dal;
        //int xtotalrecords = 0;
        Dictionary<string, string> xdic_chars = new Dictionary<string, string>();

        public SBMyProspectCustomers_SendLinkBL()
        {
        ...
        public void RecordOperation(eRecordOperation i, int Position)
        {
            ...
            switch (i)
            {
                ...
                case eRecordOperation.Process:
                    ...
                    Prompt.Information("Sent to Prospect Customer Successfully", based.Title);
                    //if (RecordOperationResult.Length <= 0)
                    //{
