...
{
    public class SBSalesCallSummaryDAL : NoahWebLib.DatabaseHandler
    {
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public SBSalesCallSummaryDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
