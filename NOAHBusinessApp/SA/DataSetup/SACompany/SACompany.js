...
function func_Reload() {
    crLnk = "../SACompany_Gateway.aspx";
    crLnkGateKey = "SACompany";
...
function checknull(grid) {
    ...
    crnwTable = $("#" + grid + " .tblGridBody");

    var data;
    var xrow = crnwTable.find("tr").length + 1;

    var xcol = crnwTable.find("tr:eq(0) td").length;
