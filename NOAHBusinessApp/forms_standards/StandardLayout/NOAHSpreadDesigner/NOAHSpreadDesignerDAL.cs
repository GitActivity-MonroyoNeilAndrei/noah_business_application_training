...
{
    public class NOAHSpreadDesignerDAL : NoahWebLib.DatabaseHandler
    {
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public NOAHSpreadDesignerDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
