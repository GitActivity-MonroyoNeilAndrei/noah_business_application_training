...
//    # Date Modified : July 20 2021 / 8:26 PM  - January 27, 2021
...
(function () {
	...
	function fnUILoadAlertv2() {
	    ...
	    $doc.on("click", "#btnAlertBoxv2", function () {
	        $(".nw-alert-parent").css("display", "flex");
	    });

	    $doc.on("click", ".nw-close-alert", function () {
	        $(this).parents(".nw-alert").fadeOut().delay(300).remove();
	    });
	}
	...
	function fnModalSingle() {

	    $doc.on("click", ".btn.btn-modal-rescale-s", function () {
	        $(this).parents(".modal-box-s").toggleClass("fullscreen");
	    });
	}
	...
	$(document).ready(function () {
	    ...
	    $doc.on("mouseup", ".table thead th:not([data-type='none'])", function (e) {
	        var xxindex = $(this).parents().index();
	        var xxindex0 = $(this).index();
	        if (xxindex >= 1) return;
	        if (xxindex0 == 0) return;
	...
	function fnGridList() {
	    $doc.on("click", ".ex-item", function () {
	        $(".ex-item").removeClass("active");
	        $(this).addClass("active");
	    })


	    $doc.on("click", ".nwListView", function () {
	        $(".nw-panel-folder").addClass("nwList");
	    ...
	    $doc.on("click", ".nwGridView", function () {
	        $(".nw-panel-folder").removeClass("nwList");
...
$(document).on("change", ".check-group input:checkbox", function () {
...
$(document).ready(function () {
    $("label.lbl-rdo.noah-forms-lbl.nf-opt-lbl input").focus(function () {
        $(this).closest("label.lbl-rdo.noah-forms-lbl.nf-opt-lbl").trigger("click")
    });

    $(".lbl-chk.nf-check-lbl input").focus(function () {
        $(this).closest(".lbl-chk.nf-check-lbl").trigger("click")
    });

    $(".lbl-chk.nf-wo-chk-lbl input").focus(function () {
