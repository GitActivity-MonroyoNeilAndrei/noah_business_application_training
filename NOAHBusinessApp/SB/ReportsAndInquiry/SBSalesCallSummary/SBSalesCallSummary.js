const pageTitle = "Sales Call Summary";
...
function func_Reload() {
    crLnk = "../SBSalesCallSummary/SBSalesCallSummary_Gateway";
    crLnkGateKey = "SBSalesCallSummary";

    $("#settingstabs").loadAddtoList({ list: ["Sales Force Activity", "Prospect Customer"], icon: true });
