function func_Reload() {
    crLnk = GetCurrentURL() + "LMSCommunicationType_Gateway";
    crLnkGateKey = "LMSCommunicationType";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Do you want to save the current record?", "Communication Type", "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Do you want to delete the current record?", "Communication Type", "", indef, enume);
    isContinue = false;
    return isContinue;
}
...
function cust_GetPara() {
    ...
    nwParameter_Add("rdEmail", $('#rdEmail').is(":checked"));
    nwParameter_Add("rdLandline", $('#rdLandline').is(":checked"));
    nwParameter_Add("rdMobile", $('#rdMobile').is(":checked"));
}
...
function EnableFields() {
    ...
    $("#rdEmail").enable(true);
    $("#rdLandline").enable(true);
    $("#rdMobile").enable(true);
}

function DisableFields() {
    $("#txtCode").prop("disabled", true);
    $("#txtDescription").prop("disabled", true)
    $("#rdEmail").enable(false);
    $("#rdLandline").enable(false);
    $("#rdMobile").enable(false);
