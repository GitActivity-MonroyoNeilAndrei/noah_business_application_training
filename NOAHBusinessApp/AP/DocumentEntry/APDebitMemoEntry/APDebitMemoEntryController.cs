...
{
    public class APDebitMemoEntryController : nwStandardGateway
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(@"~\AP\DocumentEntry\APDebitMemoEntry\APDebitMemoEntry.cshtml");
        }

        public ActionResult APDebitMemoEntry_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    APDebitMemoEntryBL APDebitMemoEntryBL = new APDebitMemoEntryBL();
                    based.Title = "AP Debit Memo Entry";
                    APDebitMemoEntryBL.main(ref strFinal, strmet,
