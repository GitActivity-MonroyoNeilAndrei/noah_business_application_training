function func_Reload() {
    crLnk = GetCurrentURL() +  "APPayeeType_Gateway";
    crLnkGateKey = "APPayeeType";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Do you want to save the current record?", "Payee Type", "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Do you want to delete the current record?", "Payee Type", "", indef, enume);
    isContinue = false;
    return isContinue;
}
