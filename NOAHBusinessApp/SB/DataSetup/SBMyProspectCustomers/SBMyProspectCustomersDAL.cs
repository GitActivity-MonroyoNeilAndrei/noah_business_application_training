...
{
    public class SBMyProspectCustomersDAL : DatabaseHandler
    {
        ...
        //public string inquireQuery = "EXEC [PRT].[nsp_SBMyProspectCustomers] @QueryType = 6, @recuser='{1}'", RecUser;
        public string inquireQuery(string RecUser)
        {
            return string.Format($@"EXEC {spName} @QueryType = 6, @recuser='{RecUser}'", _ConnectionString);
        }

        public SBMyProspectCustomersDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
        ...
        public string getCivilStatus(string code)
        {
            ...
            //return string.Format($@"EXEC [PRT].[nsp_SBMyProspectCustomers] @QueryType = 23, @custtagging='{vip}'", _ConnectionString);
        }
        ...
        public string getCustTagging()
        {
            ...
            string sql = string.Format(@"SELECT VIP,MI FROM  PRT.SBMyProspectCustomers");
            return sql;
        }
        ...
        //{
        //    string sql = $"Exec [PRT].[nsp_SBMyProspectCustomers] @Querytype =31 , @CustomerCode='{CustomerCode}', @TIN = '{TIN}'";
        //    return SFObjects.returnText(sql, _ConnectionString);
        //}
