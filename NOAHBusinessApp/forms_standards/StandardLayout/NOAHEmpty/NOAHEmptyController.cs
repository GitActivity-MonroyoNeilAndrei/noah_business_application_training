...
{
    public class NOAHEmptyController : nwStandardGateway
    {
        public ActionResult Index()
        {
            ...
            return View(@"~\forms_standards\StandardLayout\NOAHEmpty\NOAHEmpty.cshtml");
        }


        public ActionResult NOAHEmpty_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    NOAHEmptyBL menuBL = new NOAHEmptyBL();
