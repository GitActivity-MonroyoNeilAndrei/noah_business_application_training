...
{
    public class SBMyProspectCustomers_SendLinkDAL : DatabaseHandler
    {
        nwSFObjects SFObjects = new nwSFObjects(); /// should be added
        #region STANDARD

        public string MenuItemCode = "SBMyProspectCustomers_SendLink"; // This is default parameter  for version
        ...
        public string spName = "[PRT].[nsp_SBMyProspectCustomers_SendLink]";
        public string spName1 = "[PRT].[nsp_SBMyProspectCustomers]";
        ...
        //public string inquireQuery = "EXEC [PRT].[nsp_SBMyProspectCustomers_SendLink] @QueryType = 6, @recuser='{1}'", RecUser;
        public string inquireQuery(string RecUser)
        {
            return string.Format($@"EXEC {spName} @QueryType = 6, @recuser='{RecUser}'", _ConnectionString);
        }

        public SBMyProspectCustomers_SendLinkDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
        ...
        public string getCivilStatus(string code)
        {
            ...
            //return string.Format($@"EXEC [PRT].[nsp_SBMyProspectCustomers_SendLink] @QueryType = 23, @custtagging='{vip}'", _ConnectionString);
        }
        ...
        public string getCustTagging()
        {
            ...
            string sql = string.Format(@"SELECT VIP,MI FROM  PRT.SBMyProspectCustomers_SendLink");
            return sql;
        }
        ...
        //{
        //    string sql = $"Exec [PRT].[nsp_SBMyProspectCustomers_SendLink] @Querytype =31 , @CustomerCode='{CustomerCode}', @TIN = '{TIN}'";
        //    return SFObjects.returnText(sql, _ConnectionString);
        //}
