...
{
    public class BasicInformationController : nwStandardGateway
    {
        public ActionResult Index()
        {
            mainDataAccess main = new mainDataAccess();
            main.MenuAccess(User, this);
            return View(@"~\RE\ReportsAndInquiry\BasicInformation\BasicInformation.cshtml");
        }
        ...
        public ActionResult Index2()
        {
            Response.Write("AA1");
            return null;
            //return View(@"~\RE\ReportsAndInquiry\BasicInformation\BasicInformation2.cshtml");
        }


        public ActionResult BasicInformation_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    BasicInformationBL menuBL = new BasicInformationBL();
