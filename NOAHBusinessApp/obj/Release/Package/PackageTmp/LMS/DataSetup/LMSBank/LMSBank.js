function func_Reload() {
    ...
    crLnk = GetCurrentURL() + "LMSBank_Gateway";
    crLnkGateKey = "LMSBank";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Would you like to save the current record?", "Bank", "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Would you like to delete the current record?", "Bank", "", indef, enume);
    isContinue = false;
    return isContinue;
}
...
function func_ToolboxNavigatorBind_Empty() {
    nwLoading_Start("emptyreload", crLoadingHTML);
    js.ADD("RefreshData();");
