...
{
    public class SBSalesCallController : nwStandardGateway
    {
        public ActionResult Index()
        {
            mainDataAccess main = new mainDataAccess();
            main.MenuAccess(User, this);
            return View(@"~\SB\DataSetup\SBSalesCall\SBSalesCall.cshtml");
        }
        ...
        public ActionResult Index2()
        {
            Response.Write("AA1");
            return null;
            //return View(@"~\RE\DataSetup\SBSalesCall\SBSalesCall.cshtml");
        }

        public ActionResult SBSalesCall_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    SBSalesCallBL menuBL = new SBSalesCallBL();
                    based.Title = "Sales Call";
