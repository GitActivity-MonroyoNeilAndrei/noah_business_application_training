...
{
    public class PMOBasicInformationBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            dal = new PMOBasicInformationDAL(this.UserDefinedConnectionString, this.based.SecurityAccess.ConnectionString, "");
        ...
        {
            string recuser =  based.SecurityAccess.RecUser.ToUpper();// dal.getuser(nwtku/*.Replace("AAGxAAG", "+")*/);
            GetDataDetails(recuser);

            js.makeValueText("#txtAccNo", recuser);
            string AccountNo = WebApp.nwobjectText("txtAccNo");
            DataTable dr1 = dal.GetContact(recuser);
            ...
            js.makeValueText("#txtCustName", TCaseName + "");

            js.makeText("#lblCustName", TCaseName + "");
            js.makeText("#lblCustAccNo", recuser);
        ...
        private DataTable GetDataLIN()
        {
            ...
            DataTable dt = dal.GetDataLIN(recuser, AccountNo);

            return dt;
        }

        private void GetDataDetails(string accNo)
        {
            string recuser = based.SecurityAccess.RecUser;
            ...
            {
                DataTable dt = dal.GetDetails(recuser, AccountNo);
