...
{
    public class FPTIIssueLogsController : nwStandardGateway
    {
        public ActionResult Index()
        {
           mainDataAccess main = new mainDataAccess();
            ...
            return View(@"~\RND\DocumentEntry\FPTIIssueLogs\FPTIIssueLogs.cshtml");
        }
        ...
        public ActionResult Index2()
        {
            Response.Write("AA1");
            return null;
            //return View(@"~\SA\DataSetup\FPTIIssueLogs\FPTIIssueLogs.cshtml");
        }

        public ActionResult FPTIIssueLogs_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    FPTIIssueLogsBL menuBL = new FPTIIssueLogsBL();
