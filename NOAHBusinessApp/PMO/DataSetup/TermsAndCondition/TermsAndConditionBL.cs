...
{
    public class TermsAndConditionBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            dal = new TermsAndConditionDAL(this.UserDefinedConnectionString, this.based.SecurityAccess.ConnectionString, "");
        ...
        private void Main_Load()
        {
            ...
            string TACTerms = dal.getTAC();
            js.makeValueText("#txtTAC", TACTerms);
            js.ADD("generateTAC();");


            //js.ADD($"$('#divTAC').html('{TACTerms}');");
        }
