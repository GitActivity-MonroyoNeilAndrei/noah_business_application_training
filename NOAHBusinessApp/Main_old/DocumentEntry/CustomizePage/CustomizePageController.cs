...
{
    public class CustomizePageController : nwStandardGateway
    {
        ...
        public ActionResult Index()
        {
            ...
            //if(SFObjects.returnText($"select InitialLogin from [fpti].[user] where code ='{User.Identity.Name}'",nwSystem.ARKDB_ConnectionString()) == "1")
            //{
