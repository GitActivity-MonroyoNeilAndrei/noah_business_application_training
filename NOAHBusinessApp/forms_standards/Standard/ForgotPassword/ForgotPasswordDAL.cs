...
{
    public class ForgotPasswordDAL : NoahWebLib.DatabaseHandler
    {
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public ForgotPasswordDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
