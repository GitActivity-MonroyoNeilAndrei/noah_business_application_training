...
{
    public class APBIRFormsAuthorizedSignatoryAssignmentController : nwStandardGateway
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(@"~\AP\DataSetup\APBIRFormsAuthorizedSignatoryAssignment\APBIRFormsAuthorizedSignatoryAssignment.cshtml");
        }

        public ActionResult APBIRFormsAuthorizedSignatoryAssignment_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    APBIRFormsAuthorizedSignatoryAssignmentBL APBIRFormsAuthorizedSignatoryAssignmentBL = new APBIRFormsAuthorizedSignatoryAssignmentBL();
                    based.Title = "BIR Forms Authorized Signatory Assignment";
                    APBIRFormsAuthorizedSignatoryAssignmentBL.main(ref strFinal, strmet,
