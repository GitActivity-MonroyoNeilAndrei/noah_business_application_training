...
{
    public class Transaction_HistoryDAL : NoahWebLib.DatabaseHandler
    {
        nwSFObjects SFObjects = new nwSFObjects();
        #region STANDARD

        public string MenuItemCode = "Transaction_History"; // This is default parameter  for version
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public Transaction_HistoryDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
        ...
        public DataTable ComboBox1(string curusers)
        {
        ...
        {
            string query3 = string.Format(@"EXEC " + storedProcedureName + " @QueryType = 22");
        ...
        public DataTable GetDataLIN(string curuser, string AccNo, string TranType, string Charges, string dateFrom, string dateTo)
        {
            string query5 = string.Format(@"EXEC " + storedProcedureName + " @QueryType = 24, @AccNo = '" + AccNo + "', @TranType = '" + TranType + "', @Charges = '" + Charges + "', @DateFrom = '" + dateFrom + "', @DateTo = '" + dateTo + "'");
