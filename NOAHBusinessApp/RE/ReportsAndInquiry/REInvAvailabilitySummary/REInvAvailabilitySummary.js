...
function func_Reload() {
    LoadStringsCases();
    crnwTagSigleBind = true;
    crLnk = "../REInvAvailabilitySummary/REInvAvailabilitySummary_Gateway";
    crLnkGateKey = "REInvAvailabilitySummary";
    var isContinue = true;
    init_request();
    $("#settingstabs").loadAddtoList({ list: ["Project", "Phase/Tower", "Unit", "Inventory Type", "Inventory Class", "Item Status"], icon: true });
