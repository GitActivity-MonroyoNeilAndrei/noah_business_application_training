...
function func_Reload() {
    ...
    crLnk = "../SBMyProspectCustomers_SendLink/SBMyProspectCustomers_SendLink_Gateway";
    crLnkGateKey = "SBMyProspectCustomers_SendLink";
...
function func_ToolboxProcess(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Do you want to send the Prospect Customer Form to Client?", "Send Link to Prospect Customer", "", indef, enume);
    isContinue = false;
    return isContinue;
}
...
function cust_GetPara() {
    nwParameter_Add("txtMobileNum", $("#txtMobileNum").val());
    nwParameter_Add("txtEAdd", $("#txtEAdd").val());
