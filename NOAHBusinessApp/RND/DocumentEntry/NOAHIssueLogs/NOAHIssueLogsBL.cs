...
{
    public class FPTIIssueLogsBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            dao = new FPTIIssueLogsDAL(based.SecurityAccess.ConnectionString, this.UserDefinedConnectionString,""); 
        ...
        FPTIIssueLogsDAL dao;
        public FPTIIssueLogsBL()
        {
