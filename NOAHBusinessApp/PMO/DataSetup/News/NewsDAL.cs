...
{
    public class NewsDAL : NoahWebLib.DatabaseHandler
    {
        nwSFObjects SFObjects = new nwSFObjects();
        #region STANDARD

        public string MenuItemCode = "News"; // This is default parameter  for version
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public NewsDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
