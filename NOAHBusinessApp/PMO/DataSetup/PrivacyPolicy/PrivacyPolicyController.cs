...
{
    public class PrivacyPolicyController : nwStandardGateway
    {
        public ActionResult Index()
        {
            mainDataAccess main = new mainDataAccess();
            main.MenuAccess(User, this); //security
            return View(@"~\PMO\DataSetup\PrivacyPolicy\PrivacyPolicy.cshtml");
        }
        ...
        public ActionResult Index2()
        {
            Response.Write("AA1");
            return null;
            //return View(@"~\RE\ReportsAndInquiry\PrivacyPolicy\PrivacyPolicy2.cshtml");
        }


        public ActionResult PrivacyPolicy_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    PrivacyPolicyBL menuBL = new PrivacyPolicyBL();
                    based.Title = "Privacy Policy";
