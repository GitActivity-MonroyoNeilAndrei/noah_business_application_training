...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public DataTable getProperty(string projtype,string loc,string htag,string phs,string recuser)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_Main] @QueryType=1,@ProjectType='" + projtype + "',@Location='" + loc + "',@HomeTag='"+htag+ "',@PhaseTower='" + phs + "',@recuser='" + recuser + "'", _ConnectionString);
        }
        public DataTable getProject(string projtype, string loc, string htag,string phs,string recuser)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_Main] @QueryType=101,@ProjectType='" + projtype + "',@Location='" + loc + "',@HomeTag='" + htag + "',@PhaseTower='" + phs + "',@recuser='" + recuser + "'", _ConnectionString);
        }
        public DataTable getLocation(string projtype,string loc,string htag,string phs, string recuser)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_Main] @QueryType=2,@ProjectType='" + projtype + "',@Location='" + loc + "',@HomeTag='" + htag + "',@PhaseTower='" + phs + "',@recuser='" + recuser + "'", _ConnectionString);
        }
        public DataTable getPhaseTower(string projtype, string loc, string htag,string phs,string recuser)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_Main] @QueryType=102,@ProjectType='" + projtype + "',@Location='" + loc + "',@HomeTag='" + htag + "',@PhaseTower='" + phs + "',@recuser='" + recuser + "'", _ConnectionString);
        }
        public DataTable getProjectDtls(string type, string loc, string htag,string proj,string phs,string recuser)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_Main] @QueryType=3,@ProjectType='" + type + "',@Location='" + loc + "',@HomeTag='" + htag + "',@Project='" + proj + "',@PhaseTower='"+phs+ "',@recuser='" + recuser + "'", _ConnectionString);
        }
        ...
        public DataTable getCountStatus(string status,string user,string proj,string proj2,int reopen)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_MyBookingSummary] @QueryType=40,@Status='" + status + "',@Recuser='" + user + "',@UnitCode='',@Project='" + proj + "',@isReopen=" + reopen + ", @Project2 = '" + proj2 + "'", _ConnectionString);
        }
        public DataTable getCountStatus2(string status, string user, string proj, int reopen, string unitcode, string customer, int tag, string proj2)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_MyBookingSummary] @QueryType=44,@Status='" + status + "',@Recuser='" + user + "',@Project='" + proj + "',@isReopen=" + reopen + ", @UnitCode = '" + unitcode + "', @Customer = '" + customer + "', @tag = " + tag + ", @Project2 = '" + proj2 + "'", _ConnectionString);
        }
        ...
        public DataTable getNonSetupUnits(string project,string projecttype,string phtw,string floorblock,string isLTO)
        {
            return SFObjects.LoadDataTable($@"EXEC [PRT].[nsp_Main] @QueryType=18,@Project='" + project + "',@ProjectType='" + projecttype + "',@PhaseTower='" + phtw + "',@floorblock='" + floorblock + "',@isLTO='" + isLTO + "'", _ConnectionString);
        }
        //UNIT AVAILABILITY
        ...
        public string CheckForeignVal(string proj)
        {
            return SFObjects.returnText(string.Format($"EXEC [PRT].[nsp_Main] @QueryType = 36, @Project = '{proj}'"), _ConnectionString);
        }
    }
}