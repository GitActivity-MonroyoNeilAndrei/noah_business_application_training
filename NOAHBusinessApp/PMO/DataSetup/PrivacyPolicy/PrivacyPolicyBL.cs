...
{
    public class PrivacyPolicyBL : nwAction
    {
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            dal = new PrivacyPolicyDAL(this.UserDefinedConnectionString, this.based.SecurityAccess.ConnectionString, "");
        ...
        private void Main_Load()
        {
            ...
            string PrivPol = dal.getDataPrivacy();
            js.ADD($"$('#divPrivPol').html('{PrivPol}');");
        }
