...
{
    public class APVITAController : nwStandardGateway
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(@"~\AP\DataSetup\APVITA\APVITA.cshtml");
        }

        public ActionResult APVITA_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    APVITABL APVITABL = new APVITABL();
                    based.Title = "Vendor Item Tax Assignment";
                    APVITABL.main(ref strFinal, strmet,
