function func_Reload() {
    crLnk = GetCurrentURL() + "LMSModel_Gateway";
    crLnkGateKey = "LMSModel";
...
function func_ToolboxSave(indef, enume) {
    ...
    parent_MessageBoxQuestionToolBox("Would you like to save the current record?", "Model", "", indef, enume);
    isContinue = false;
...
function func_ToolboxDelete(indef, enume) {
    var isContinue = true;
    cust_GetPara();
    parent_MessageBoxQuestionToolBox("Would you like to delete the current record?", "Model", "", indef, enume);
    isContinue = false;
    return isContinue;
}
