...
{
    public class WFMActivityRqrmntComplianceEntryController : nwStandardGateway
    {
        public ActionResult Index()
        {
            ...
            return View(@"~\WFM\DocumentEntry\WFMActivityRqrmntComplianceEntry\WFMActivityRqrmntComplianceEntry.cshtml");
        }

        public ActionResult WFMActivityRqrmntComplianceEntry_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    WFMActivityRqrmntComplianceEntryBL menuBL = new WFMActivityRqrmntComplianceEntryBL();
                    based.Title = "Active Type Details Entry";
