...
{
    public class PMOPaymentHistoryDAL : NoahWebLib.DatabaseHandler
    {
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public PMOPaymentHistoryDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
        ...
        public System.Data.DataTable getDetails(string dateFilterFrom, string dateFilterTo, string PaymentType, string mop, string user)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "[PMO].[nsp_PaymentHistorySOA]";
            cmd.Parameters.Clear();
        ...
        public string lugPaymentType()
        {
            return string.Format($@"EXEC [PMO].[nsp_PaymentHistorySOA] @QueryType = 10");
        }
