...
{
    public class SPLTOEntryBL : nwAction
    {
        ...
        public string trantype = "LTOENT";

        //Change this according to Printing Type
        public static string PRINTTYPE = "Lease To Own Entry";
        ...
        public const int
            ...
            SPR_PaymentTermDetails_PaymentCategory = 1,
            SPR_PaymentTermDetails_PaymentTermCode = 2,
            SPR_PaymentTermDetails_PaymentTermDesc = 3,
            SPR_PaymentTermDetails_ContractRate = 4,
            SPR_PaymentTermDetails_TermAmount = 5,
            SPR_PaymentTermDetails_MiscInstallment = 6,
            SPR_PaymentTermDetails_ContractAmount = 7,
            SPR_PaymentTermDetails_SalesDiscount = 8,
            SPR_PaymentTermDetails_DPDiscount = 9,
            SPR_PaymentTermDetails_DPDiscountRate = 10,
            SPR_PaymentTermDetails_DPDiscountAmount = 11,
            SPR_PaymentTermDetails_NetContractPrice = 12,
            SPR_PaymentTermDetails_NoOfPayments = 13,
            SPR_PaymentTermDetails_MonthlyPayment = 14,
            SPR_PaymentTermDetails_InterestRate = 15,
            SPR_PaymentTermDetails_PenaltyRate = 16,
            SPR_PaymentTermDetails_StartDate = 17,
            SPR_PaymentTermDetails_EndDate = 18,
            SPR_PaymentTermDetails_MiscellaneousDate = 19,
            SPR_PaymentTermDetails_MiscellaneousType = 20,
            SPR_PaymentTermDetails_AllocationType = 21,
            SPR_PaymentTermDetails_MiscellaneousAmount = 22,
            SPR_PaymentTermDetails_Ordering = 23,
            SPR_PaymentTermDetails_MonthlyPaymentWithoutMisc = 24,
            SPR_PaymentTermDetails_DPDiscPrin=25,
            SPR_PaymentTermDetails_DPDiscMisc=26,
           ...
           string strtemp3, string strtemp4, string strtemp5, ref nwEntry baseds, string UserDefinedConnection)
        {
            ...
            //Addchars();
            dal = new SPLTOEntryDAL(this.UserDefinedConnectionString, based.SecurityAccess.ConnectionString, "");
        ...
        public string get_Method(string strMethod, string strSearchVal, string strParameter, string strValue)
        {
            ...
            switch (strMethod)
            {
                ...
                case "getlugPaymentCategory":
                    //string a = WebApp.nwobjectText("idvallugBranchProject");
                    //string b = WebApp.nwobjectText("ddtxtPhase");
                    //string c = WebApp.nwobjectText("idvallugFinancingType");

                    strSQL = dal.getPaymentCategory(WebApp.nwobjectText("idvallugBranchProject"), WebApp.nwobjectText("ddtxtPhase"), WebApp.nwobjectText("idvallugFinancingType"), WebApp.nwobjectText("isWithReserve"));
                    nwObject.ColumnHide(3);
                    //nwObject.ColumnHide(4);
                    strMethod = strMethod.Substring(3);
                    strFinal = nwObject.make_TableLookup(strMethod, strSQL, strConn, emptyDT, mouseDownFunc, mouseOverFunc);
                ...
                case "getlugApproverCode":
                    ...
                    strFinal = nwObject.make_TableLookup(strMethod, strSQL, strConn, emptyDT, mouseDownFunc, mouseOverFunc);
                    break;
                case "getlugSrcOfAwareness":
                    strSQL = dal.getSrcOfAwareness();
                    strMethod = strMethod.Substring(3);
                    strFinal = nwObject.make_TableLookup(strMethod, strSQL, strConn, emptyDT, mouseDownFunc, mouseOverFunc);
                    break;
                case "getlugRsnForBuying":
                    strSQL = dal.getRsnForBuying();
                    strMethod = strMethod.Substring(3);
                    strFinal = nwObject.make_TableLookup(strMethod, strSQL, strConn, emptyDT, mouseDownFunc, mouseOverFunc);
                    break;
        ...
        public void RecordOperation(eRecordOperation i, int Position)
        {
            ...
            switch (i)
            {
                case eRecordOperation.AddNew:
                    ...
                    expirationPeriod = dal.GetExpirationPeriod(trantype);
                ...
                case eRecordOperation.Save:
                    ...
                    if (RecordOperationResult == "")
                    {
                            ...
                            LoadHoldforReservationPaymentTermDetails(),
                            LoadHoldforReservationAddOns(),
                            LoadHoldforReservationDiscount(),
                            LoadHoldforReservationEntry_Amortization(),
                            LoadHoldforReservationCoBuyer(),
                            trantype,
        ...
        public string act_Method(string strMethod, string strParameter, string strValue)
        {
            ...
            switch (strMethod)
            {
                ...
                case "actAmortization":
                    ...
                    if (RecordOperationResult == string.Empty)
                    {
                        ...
                        if (nwDocno == "")
                        {
                            ...
                            string reservStartDate = "", reservEndDate = "";
                            ...
                            double dpdisc8 = 0.00;
                            double dpdisc9 = 0.00;
                            double dpdisc10 = 0.00;
                            double dpdisc11 = 0.00;
                            double dpdisc12 = 0.00;
                            double dpdisc13 = 0.00;
                            double dpdisc14 = 0.00;
                            double dpdisc15 = 0.00;
                            double dpdisc16 = 0.00;
                            double dpdisc17 = 0.00;
                            double dpdisc18 = 0.00;
                            double dpdisc19 = 0.00;
                            double dpdisc20 = 0.00;
                            double dpdiscMisc = WebApp.nwobjectDouble("dpdiscMisc");
                            double dpdiscPrin = WebApp.nwobjectDouble("dpdiscPrin");

                            if (discountamount <= 0)
                            {
                                netLotUnitPrice = WebApp.nwobjectDouble("grossSellingPrice") - WebApp.nwobjectDouble("salesdisc") - dpdiscPrin;
                                misc = WebApp.nwobjectDouble("misc") - WebApp.nwobjectDouble("dcmisc") - dpdiscMisc;
                            }
                            else
                            {
                                ...
                                {
                                    netLotUnitPrice = WebApp.nwobjectDouble("grossSellingPrice") - WebApp.nwobjectDouble("salesdisc") - dpdiscPrin;
                                    misc = WebApp.nwobjectDouble("misc") - dpdiscMisc;
                                }
                                else if (ddbasis == "SP" && ddapp == "TCP")
                                {
                                    netLotUnitPrice = WebApp.nwobjectDouble("grossSellingPrice") - WebApp.nwobjectDouble("sp") - dpdiscPrin;
                                    misc = WebApp.nwobjectDouble("misc") - WebApp.nwobjectDouble("dcmisc") - dpdiscMisc;
                                }
                                else
                                {
                            ...
                            {
                                if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() != string.Empty)
                                {
                                    if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "RESRV")
                                    {
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 1)
                                    {
                                        ...
                                        dpdisc1 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc1 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc1;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc1 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : ((Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * ((Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) + reservMonthlyMisc) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc1);
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc1 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc1;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc1 = (((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - WebApp.nwobjectDouble("reservMisc")) - dpdisc1; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc1 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 2)
                                    {
                                        ...
                                        dpdisc2 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc2 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc2;
                                        }
                                        else
                                        {
                                            if (ddbasis == "SP" && ddapp == "SP")
                                            ...
                                            else
                                            {
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc2 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc2;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc2 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc2;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc2 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc2; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc2 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 3)
                                    {
                                        ...
                                        dpdisc3 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);

                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc3 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc3;
                                        }
                                        else
                                        {
                                            if (ddbasis == "SP" && ddapp == "SP")
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc3 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc3;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc3 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc3;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc3 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc3; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc3 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 4)
                                    {
                                        ...
                                        dpdisc4 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc4 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc4;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc4 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc4;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc4 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc4;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc4 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc4; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc4 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 5)
                                    {
                                        ...
                                        dpdisc5 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc5 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc5;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc5 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc5;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc5 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc5;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc5 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc5; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc5 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 6)
                                    {
                                        ...
                                        dpdisc6 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc6 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc6;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc6 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc6;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc6 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc6;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc6 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc6; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc6 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 7)
                                    {
                                        ...
                                        dpdisc7 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc7 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc7;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc7 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc7;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc7 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc7;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc7 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc7; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc7 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 8)
                                    {
                                        ...
                                        dpdisc8 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc8 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc8;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc8 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc8;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc8 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc8;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc8 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc8; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc8 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 9)
                                    {
                                        ...
                                        dpdisc9 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc9 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc9;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc9 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc9;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc9 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc9;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc9 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc9; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc9 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 10)
                                    {
                                        ...
                                        dpdisc10 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc10 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc10;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc10 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc10;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc10 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc10;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc10 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc10; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc10 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 11)
                                    {
                                        ...
                                        dpdisc11 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc11 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc11;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc11 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc11;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc11 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc11;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc11 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc11; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc11 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 12)
                                    {
                                        ...
                                        dpdisc12 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc12 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc12;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc12 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc12;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc12 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc12;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc12 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc12; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc12 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 13)
                                    {
                                        ...
                                        dpdisc13 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc13 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc13;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc13 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc13;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc13 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc13;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc13 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc13; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc13 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 14)
                                    {
                                        ...
                                        dpdisc14 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc14 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc14;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc14 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc14;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc14 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc14;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc14 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc14; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc14 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 15)
                                    {
                                        ...
                                        dpdisc15 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc15 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc15;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc15 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc15;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc15 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc15;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc15 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc15; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc15 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 16)
                                    {
                                        ...
                                        dpdisc16 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc16 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc16;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc16 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc16;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc16 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc16;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc16 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc16; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc16 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 17)
                                    {
                                        ...
                                        dpdisc17 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc17 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc17;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc17 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc17;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc17 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc17;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc17 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc17; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc17 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 18)
                                    {
                                        ...
                                        dpdisc18 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc18 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc18;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc18 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc18;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc18 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc18;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc18 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc18; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc18 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 19)
                                    {
                                        ...
                                        dpdisc19 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc19 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc19;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc19 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc19;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc19 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc19;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc19 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc19; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc19 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "DOWNP" && dp == 20)
                                    {
                                        ...
                                        dpdisc20 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_DPDiscMisc - 1]);
                                        if (discountamount <= 0)
                                        {
                                            dpMonthlyMisc20 = Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - dpdisc20;
                                        }
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (ddapp == "TCP")
                                                {
                                                    dpMonthlyMisc20 = WebApp.nwobjectDouble("txtMisc") == 0 ? 0 : (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) - (WebApp.nwobjectDouble("dcmisc") * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]) / WebApp.nwobjectDouble("txtMisc")))) - dpdisc20;
                                                }
                                                else
                                                {
                                                    if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED")
                                                        dpMonthlyMisc20 = (WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) - dpdisc20;
                                                    else if (dr[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "AMORT")
                                                        dpMonthlyMisc20 = ((WebApp.nwobjectDouble("txtMisc") - WebApp.nwobjectDouble("dcmisc")) * (Parser.ParseDouble(dr[SPR_PaymentTermDetails_ContractRate - 1]) / 100)) - dpdisc20; //Parser.ParseDouble(dr[SPR_PaymentTermDetails_MiscInstallment - 1]);
                                                    else
                                                        dpMonthlyMisc20 = 0;
                                                }
                                            }
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "BALANC" && bal == 1)
                                    {
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "BALANC" && bal == 2)
                                    {
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "BALANC" && bal == 3)
                                    {
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "BALANC" && bal == 4)
                                    {
                                    ...
                                    else if (dr[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() == "SPOT")
                                    {
                        ...
                        {
                            dtAmort = dal.getHoldAmortForViewing(WebApp.nwobjectText("ReservationControlNo"));
                        }

                        CreateTermDetails(true);
                    ...
                    break;
                case "actExportAmort":
                    DataTable jsonHDR = JSONToDataTable(WebApp.nwobjectText("jsonHDR")),
                              jsonTermDetails = JSONToDataTable(WebApp.nwobjectText("jsonTermDetails")),
                              jsonAmort = JSONToDataTable(WebApp.nwobjectText("jsonAmort"));

                    RecordOperationResult = string.Empty;
                    if (RecordOperationResult == string.Empty)
                    {
                        RecordOperationResult = dal.SaveJsonAmort(jsonHDR, jsonTermDetails, jsonAmort, based.SecurityAccess.RecUser);
                    }
                    else
                    {
                        Prompt.Error(RecordOperationResult, based.Title);
                    ...
                    PrintPreview();
                    js.ADD("nwLoading_End('actExportAmort')");
                ...
                case "actStatementDetails":
                    ...
                    js.ADD("nwLoading_End('actStatementDetails')");
                    break;
                case "actSavingStatementDetails":
                    ...
                    if (RecordOperationResult.IndexOf("Error") != 0)
                        ...
                        Prompt.Error(RecordOperationResult, based.Title);
                    js.ADD("nwLoading_End('actSavingStatementDetails')");
                    break;
                case "actPopulateDefaultMCF":
                    ...
                    js.ADD("nwLoading_End('actPopulateDefaultMCF');");
                    break;
                //case "actPhase":
                //    js.makeComboBox("#ddtxtPhase", dal.LoadComboPhase(WebApp.nwobjectText("idvallugBranchProject")));
                //    break;
                ...
                case "actPaymentTermGrouping":
                    ...
                    DataTable dtPaymentDiscount = dal.PopulateDiscountTab(WebApp.nwobjectText("Code"));
                    js.ADD($@"LoadDefaultPaymentTermGrouping('{DataTableToJSON(dal.PopulatePaymentTermGrouping(
                        ...
                        WebApp.nwobjectText("reservDate")))}','{DataTableToJSON(dtPaymentDiscount)}');");
                ...
                case "actPopulateCategory":
                    js.makeComboBox(".clsCategory", dal.LoadCategory(WebApp.nwobjectText("idvallugFinancingType"), WebApp.nwobjectText("UnitCode"), WebApp.nwobjectText("idvallugBranchProject"), WebApp.nwobjectText("ddPhaseTower"), WebApp.nwobjectText("txtUnitType"), WebApp.nwobjectText("txtUnitClass")));
                ...
                case "actMiscellaneous":
                    ...
                    RecordOperationResult = string.Empty;
                    RecordOperationResult = ValidateMiscellaneous();
                    if (RecordOperationResult == string.Empty)
                    {
                        js.ADD("nwPopupForm_ShowModal('nwMisc');");
        ...
        public void PrintPreview()
        {
            ...
            drPreview["klin"] = dal.getDocWriterValue().Rows[0]["klin"].ToString();
            drPreview["RecUser"] = REcuser;
            drPreview["dcpagename"] = "Amortization Schedule";
            ...
            js.ADD(string.Format("ShowDocWriterPreview('{0}',{1}, '{2}')", url, dtPreviewJson, "NOAH_" + based.Title + "_" + date + "_" + docno));
        }
        ...
        private string ValidateProcessDetails()
        {
            ...
            if (dt.Rows.Count <= 0)
            {
                error += "Cannot Continue. Approver Details is required.\n";
            }
            ...
            foreach (DataRow r in dt.Rows)
            {
                ...
                {
                    error += "Cannot Continue. Approver is required at Approval Level [" + r["Level"].ToString() + "].\n";
                }
            }
        ...
        private string ValidationForStatementDetails()
        {
            ...
            if (dt.Rows.Count <= 0)
                errorResult += $"Cannot Save. Line details is required.\n";
            else
            {
        ...
        public string getToolBoxData(string tableName, string getMethod, string strParameter, string strValue)
        {
            ...
            switch (getMethod)
            {
                case "toolbox":
                    ...
                    strFinal = standardBL.LoadToolBoxData("#noah-webui-Toolbox-BindingNavigator", dal.GetData(based.SecurityAccess.RecUser, nwDocno), this.UserDefinedConnectionString);
        ...
        private void BindCollection()
        {
            ...
            js.ADD("$('#btnMiscellaneousDetails,#btnLoadCoBuyerDetails').enable(true)");
            js.ADD("$('#btnMiscellaneousDetails,#btnLoadCoBuyerDetails').css({ 'background': 'rgb(255,153,0)', 'color': 'white' });");
            js.ADD("$('#settingstabs-1').enable(false)");
            js.ADD("fn_Outside();");
        ...
        void setRqmtCompProp()
        {
            if (dal.hasSavedRqrdCompli(WebApp.nwobjectText("ReservationControlNo")) == "True")
            {
                js.ADD("$('#btnReqCompHDR').removeClass('btnOrange');");
                js.ADD("$('#btnReqCompHDR').addClass('btnGreen');");
            }
            else
            {
                js.ADD("$('#btnReqCompHDR').removeClass('btnGreen');");
                js.ADD("$('#btnReqCompHDR').addClass('btnOrange');");
            }
        }
        private string ValidateData()
        {
            ...
            if (WebApp.nwobjectText("idvallugClient").Length <= 0)
                errorResult += "Cannot Generate. Client is required. \n";

            if (WebApp.nwobjectText("ReservationDate").Length <= 0)
                errorResult += "Cannot Generate. Reservation Date is required. \n";
            if (WebApp.nwobjectText("ExpirationDate").Length <= 0)
                errorResult += "Cannot Generate. Expiration Date is required. \n";



            if (WebApp.nwobjectText("idvallugFinancingType").Length <= 0)
            {
                errorResult += "Cannot Generate. Financing Type is required. \n";
            }
            else
            {
                if (WebApp.nwobjectText("idvallugFinancingType") != "SPOT")
            ...
            if (WebApp.nwobjectText("txtDPStartDate") != string.Empty && WebApp.nwobjectText("txtBalStartDate") != string.Empty)
            {
                ...
                {
                    errorResult += "Cannot Generate. Invalid Date. Balance Start Date should not overlapped the DP Start Date. \n";
                }
            }

            //if (Parser.ParseDouble(WebApp.nwobjectText("NoOfUnits")) != Parser.ParseDouble(WebApp.nwobjectText("TotalQty")))
            //    errorResult += "Cannot Generate. Total Quantity should be equal to No. of Units. \n";

            if (dtDetails.Rows.Count <= 0)
            {
                errorResult += "Cannot Generate. Payment Term Details is required. \n";
            }
            else
            {
                ...
                if (MiscLine == 0 && Misc>0)
                    errorResult += "Cannot Generate. Miscellaneous is required. \n";
                else if (MiscLine < Misc && Misc > 0)
                    errorResult += "Cannot Generate. Default Miscellaneous is insufficient. \n";
                ...
                if (WebApp.nwobjectBool("isDiscountChecked"))
                {
                    if (discountCeiling.Rows.Count <= 0)
                    {
                        ...
                        {
                            errorResult += "Cannot Generate. Please setup Discount Ceiling. \n";
                        }
                    }
                }
                ...
                foreach (DataRow dr in dtDetails.Rows)
                {
                    ...
                    {
                        errorResult += $"Cannot Generate. Payment Category is required at row {i}. \n";
                    }

                    if (dr["PaymentTerm"].ToString().ToUpper() == string.Empty)
                    {
                        errorResult += $"Cannot Generate. Payment Term is required at row {i}. \n";
                    }
                    ...
                    if (Parser.ParseInt(dr["DPDisc"].ToString()) == 1)
                    {
                        if (Parser.ParseDouble(dr["DPDiscRate"].ToString()) <= 0)
                            errorResult += "Cannot Generate. DP rate is required. \n";
                        else if (Parser.ParseDouble(dr["DPDiscAmount"].ToString()) <= 0)
                            errorResult += "Cannot Generate. DP Discount Amount is required. \n";
                ...
                //{
                //    errorResult += "Cannot Generate. Total Contract Rate should be equal to 100%. \n";
                //}

                if (ntcp != Parser.ParseDecimal(WebApp.nwobjectText("txtNTCP")))
                    errorResult += "Cannot Generate. Net Contract Price should be equal to Total Net Contract Price. \n";
                ...
                //    {
                //        errorResult += "Cannot Generate.  Invalid Contract rate in row["+(WebApp.nwobjectInt("dpIndex")+1)+ "]. It should be greater than the rate of Reservation from the Net Lot / Unit Price. \n";
                //    }
                //}
                ...
                //            errorResult += "Cannot Generate. Total Discount Rate exceed to the limit assigned in Discount Ceiling Setup. \n";
                //    }
                //    else
                //    {
                //        if (discAmt > setupDiscAmt)
                //            errorResult += "Cannot Generate. Total Discount Amount exceed to the limit assigned in Discount Ceiling Setup. \n";
                //    }
        ...
        public string ValidateMiscellaneous()
        {
            string errorResult = string.Empty;
            DataTable dtDetails = LoadHoldforReservationPaymentTermDetails();
            if (dtDetails.Rows.Count <= 0)
            {
        ...
        private string AreValidEntries(bool IsSave)
        {
            ...
            {
                errorResult += "Cannot " + SaveProcess + ". Client is required.\n";
            }
            ...
            DataTable dtUnit = LoadHoldforReservationEntryLIN();
            if (dtUnit.Rows.Count <= 0)
            {
                errorResult += "Cannot " + SaveProcess + ". Unit Details is required. \n";
            }
            else
            {
                if (isNewRow)
                {
                    if ("1" == SFObject.returnText($@"SELECT TOP 1 1 FROM re.holdforreservationentrylin a
                            JOIN re.HoldforReservationEntryHDR b ON a.TransactionNo=b.TransactionNo
                            AND b.status IN (
	                            SELECT code FROM sg.LegendStatus WHERE  posted=1 OR forEntry=1 OR forApproval=1
                            ) and b.accountstatus!=11
                            WHERE a.UnitCode='{dtUnit.Rows[0]["UnitCode"].ToString()}'", this.UserDefinedConnectionString))
                    {
                        errorResult += "Cannot " + SaveProcess + ". Unit Code is already used. \n";
                    }
                }
            }
            ...
            else
            {
                if (IsSave)
                {
                    ...
                    if (LoadHoldforReservationEntry_Amortization().Rows.Count <= 0)
                        errorResult += "Cannot be saved. Generate Amortization Schedule. \n";
                }
            }

            if (IsSave == false)
            {
                string ret = dal.validateReqCompliance(WebApp.nwobjectText("ReservationControlNo"), "0", "HLDRES", "", "");
                ...
                string revColor = dal.validatePendingReqUpdating(WebApp.nwobjectText("txtReservationControlNo"));
                if (revColor == "Red") { errorResult += $"Cannot be processed. There are pending documents requiring compliance updating for Transaction No. " + WebApp.nwobjectText("txtReservationControlNo") + ".\n"; }
            }
        ...
        private string InsuranceTabValidation(string SaveProcess)
        {
            ...
            if (WebApp.nwobjectText("ddtxtInsuranceCompany").ToString() != string.Empty)
            {
                ...
                if (dtInsuranceLin.Rows.Count <= 0)
                    errorResult += "Cannot " + SaveProcess + ". Insurance Line Details is required.\n";
            }
            ...
            if (dtInsuranceLin.Rows.Count > 0)
            {
                if (WebApp.nwobjectText("txtBirthdate") != string.Empty)
                {
                    ...
                    {
                        errorResult += "Cannot " + SaveProcess + ". Insurance is not allowed. Client is overage. \n";
                    }
                }
        ...
        private DataTable LoadSchema()
        {
            ...
            dr["UnitType"] = WebApp.nwobjectText("ddInventoryType");
            dr["UnitClass"] = WebApp.nwobjectText("ddInventoryClass");
            dr["Phase"] = WebApp.nwobjectText("ddPhaseTower");
            dr["InventoryGroup"]= WebApp.nwobjectText("ddInventoryGroup");
            ...
            dr["paymentGroupID"] = WebApp.nwobjectText("txtpaymentGroupID");
            dtHDR.Rows.Add(dr);
        ...
        private DataTable LoadHoldforReservationPaymentTermDetails()
        {
            #region don't change
            DataTable dtLIN = new DataTable();
            ...
            //DataTable dt = WebApp.nwGridData(WebApp.nwobjectText("nwGridPaymentTermDetailsCon"));

            DataTable dt = WebApp.nwGridData(WebApp.nwobjectText("nwGridPaymentTermDetailsCon"));
            //DataView dv = dt2.DefaultView;
            //dv.Sort = "Column22 asc";
            //DataTable dt = dv.ToTable();

            foreach (DataRow dr_details in dt.Rows)
            {
                if (dr_details[SPR_PaymentTermDetails_PaymentCategory - 1].ToString() != string.Empty)
                {

                    DataRow dr = dtLIN.NewRow();
                    dr["TransactionNo"] = WebApp.nwobjectText("txtReservationControlNo");
                    dr["Category"] = dr_details[SPR_PaymentTermDetails_PaymentCategory - 1].ToString();
                    dr["PaymentTerm"] = dr_details[SPR_PaymentTermDetails_PaymentTermCode - 1].ToString();
                    dr["ContractRate"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_ContractRate - 1].ToString());
                    //dr["LotPrice"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_LotPrice - 1].ToString());
                    //dr["Vat"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_VAT - 1].ToString());
                    dr["TotalLotPrice"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_TermAmount - 1].ToString());
                    dr["MiscInstallment"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_MiscInstallment - 1].ToString());
                    //dr["ContractAmount"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_ContractAmount - 1].ToString());
                    dr["SalesDisc"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_SalesDiscount - 1].ToString());
                    dr["NetLotUP"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_TermAmount - 1].ToString()) - Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_SalesDiscount - 1].ToString());
                    dr["TCP"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_ContractAmount  - 1].ToString());
                    dr["DPDisc"] = dr_details[SPR_PaymentTermDetails_DPDiscount - 1].ToString()=="true"?1:0;
                    dr["DPDiscRate"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_DPDiscountRate - 1].ToString());
                    dr["DPDiscAmount"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_DPDiscountAmount - 1].ToString());
                    dr["Ntcp"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_NetContractPrice- 1].ToString());
                    //dr["FinancingType"] = dr_details[SPR_paymenttermdetail - 1].ToString();
                    dr["NoOfPayments"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_NoOfPayments - 1].ToString());
                    dr["Interest"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_InterestRate - 1].ToString());
                    dr["Monthly"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_MonthlyPayment - 1].ToString());
                    dr["PenaltyRate"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_PenaltyRate - 1].ToString());
                    dr["StartDate"] = ValidateDate(dr_details[SPR_PaymentTermDetails_StartDate - 1].ToString())? dr_details[SPR_PaymentTermDetails_StartDate - 1].ToString(): (object)DBNull.Value;
                    dr["EndDate"] = ValidateDate(dr_details[SPR_PaymentTermDetails_EndDate - 1].ToString())? dr_details[SPR_PaymentTermDetails_EndDate - 1].ToString(): (object)DBNull.Value; //dr_details[SPR_PaymentTermDetails_EndDate - 1].ToString();
                    dr["MiscDate"] = ValidateDate(dr_details[SPR_PaymentTermDetails_MiscellaneousDate - 1].ToString()) ? dr_details[SPR_PaymentTermDetails_MiscellaneousDate - 1].ToString() : (object)DBNull.Value;
                    if (dr_details[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() != string.Empty)
                        dr["MiscellaneousType"] = dr_details[SPR_PaymentTermDetails_MiscellaneousType - 1].ToString() == "FIXED" ? 1 : 2;

                    if (dr_details[SPR_PaymentTermDetails_AllocationType - 1].ToString() != string.Empty)
                        dr["AllocationType"] = dr_details[SPR_PaymentTermDetails_AllocationType - 1].ToString();

                    dr["MiscellaneousAmount"]= Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_MiscellaneousAmount - 1].ToString());
                    dr["Rowid"] = Parser.ParseInt(dr_details[SPR_PaymentTermDetails_Ordering - 1].ToString());
                    dr["MonthlyWithoutMisc"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_MonthlyPaymentWithoutMisc - 1].ToString());
                    dr["dpDiscPrin"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_DPDiscPrin - 1].ToString());
                    dr["dpDiscMisc"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_DPDiscMisc - 1].ToString());
        ...
        //private DataTable LoadHoldforReservationPaymentTermDetails2()
        //{
        //    #region don't change
        //    DataTable dtLIN = new DataTable();
        //    dtLIN = dal.LoadHoldforReservationPaymentTermDetails();
        ...
        //    foreach (DataRow dr_details in dt.Rows)
        //    {
        //        if (dr_details[SPR_PaymentTermDetails_PaymentCategory].ToString() != string.Empty)
        //        {
        //            DataRow dr = dtLIN.NewRow();
        //            dr["TransactionNo"] = WebApp.nwobjectText("txtReservationControlNo");
        //            dr["Category"] = dr_details[SPR_PaymentTermDetails_PaymentCategory].ToString();
        //            dr["PaymentTerm"] = dr_details[SPR_PaymentTermDetails_PaymentTermCode].ToString();
        //            dr["ContractRate"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_ContractRate].ToString());
        //            dr["TotalLotPrice"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_TermAmount].ToString());

        //            dr["SalesDisc"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_SalesDiscount].ToString());
        //            dr["NetLotUP"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_NetLotUnitPrice].ToString());
        //            dr["MiscInstallment"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_MiscInstallment].ToString());
        //            dr["TCP"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_TCP].ToString());
        //            dr["DPDisc"] = Parser.ParseBool(dr_details[SPR_PaymentTermDetails_DPDiscount].ToString()) ? 1 : 0;
        //            dr["DPDiscRate"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_DPDiscountRate].ToString());
        //            dr["DPDiscAmount"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_DPDiscountAmount].ToString());
        //            dr["Ntcp"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_NTCP].ToString());
        //            dr["FinancingType"] = dr_details[SPR_PaymentTermDetails_FinancingTypeCode].ToString();
        //            dr["NoOfPayments"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_NoOfPayments].ToString());
        //            dr["Interest"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_Interest].ToString());
        //            dr["Monthly"] = Parser.ParseDouble(dr_details[SPR_PaymentTermDetails_MonthlyDP].ToString());
        ...
        private DataTable LoadHoldforReservationAddOns()
        {
            #region don't change
            DataTable dtLIN = new DataTable();
            ...
            DataTable dt = WebApp.nwGridData(WebApp.nwobjectText("nwGridAddOnCon"));

            int i = 1;
            foreach (DataRow dr_details in dt.Rows)
            {
                if (dr_details[SPR_Addon_AddonItemCode - 1].ToString() != string.Empty)
                {
                    DataRow dr = dtLIN.NewRow();
                    dr["TransactionNo"] = WebApp.nwobjectText("txtReservationControlNo");
                    dr["AddOnItem"] = dr_details[SPR_Addon_AddonItemCode - 1].ToString();
                    dr["Category"] = Parser.ParseDouble(dr_details[SPR_Addon_CategoryCode - 1].ToString());
                    dr["Rowid"] = i;
                    dr["Qty"] = Parser.ParseDouble(dr_details[SPR_Addon_Qty - 1].ToString());
                    dr["UOM"] = Parser.ParseDouble(dr_details[SPR_Addon_UOMCode - 1]);
                    //dr["PricePerUnitUOM"] = Parser.ParseDouble(dr_details[SPR_Addon_PricePerUnitUOM - 1].ToString());
                    //dr["PriceVatIn"] = Parser.ParseDouble(dr_details[SPR_Addon_PriceVatIn - 1].ToString());
                    //dr["PriceVatEx"] = Parser.ParseDouble(dr_details[SPR_Addon_PriceVatEx - 1].ToString());
                    //dr["DiscRate"] = Parser.ParseDouble(dr_details[SPR_Addon_DiscountRate - 1].ToString());
                    //dr["DiscAmt"] = Parser.ParseDouble(dr_details[SPR_Addon_DiscountAmount - 1].ToString());
                    //dr["NetAddonPriceVatIn"] = Parser.ParseDouble(dr_details[SPR_Addon_NetAddonPriceVatIn - 1].ToString());
                    //dr["NetAddonPriceVatEx"] = Parser.ParseDouble(dr_details[SPR_Addon_NetAddonPriceVatEx - 1].ToString());

                    //dr["CrossRefCode"] = Parser.ParseDouble(dr_details[SPR_Addon_CrossRefCode - 1].ToString());
                    dtLIN.Rows.Add(dr);
                    dtLIN.AcceptChanges();
                    i++;
                }
        ...
        private DataTable LoadHoldforReservationDiscount()
        {
            #region don't change
            DataTable dtLIN = new DataTable();
            ...
            foreach (DataRow dr_details in dt.Rows)
            {
                if (dr_details[SPR_Discount_DiscountCode - 1].ToString() != string.Empty)
                {
                    DataRow dr = dtLIN.NewRow();
                    dr["TransactionNo"] = WebApp.nwobjectText("txtReservationControlNo");
                    dr["DiscountCode"] = dr_details[SPR_Discount_DiscountCode - 1].ToString();
                    dr["DiscountRate"] = Parser.ParseDouble(dr_details[SPR_Discount_DiscountRate - 1].ToString());
                    dr["BasisOfDiscount"]= dr_details[SPR_Discount_BasisOfDiscount - 1].ToString();
                    dr["DiscountApplication"] = dr_details[SPR_Discount_DiscountApp - 1].ToString();
                    dr["DiscountAmount"] = Parser.ParseDouble(dr_details[SPR_Discount_DiscountAmt - 1].ToString());
                    dr["DiscountAmt_SP"] = Parser.ParseDouble(dr_details[SPR_Discount_DiscountSP - 1].ToString());
                    dr["DiscountAmount_MSC"] = Parser.ParseDouble(dr_details[SPR_Discount_DiscountMSC - 1].ToString());
                    dtLIN.Rows.Add(dr);
                    dtLIN.AcceptChanges();
                }
            }
        ...
        private DataTable LoadHoldforReservationCoBuyer()
        {
            #region don't change
            DataTable dtLIN = new DataTable();
            ...
            DataTable dt = WebApp.nwGridData(WebApp.nwobjectText("nwGridCoBuyerCon"));
            int i = 1;
            foreach (DataRow dr_details in dt.Rows)
            {
                //if (dr_details[SPR_PaymentTermDetails_PaymentCategoryCode - 1].ToString() != string.Empty)
                ...
                DataRow dr = dtLIN.NewRow();
                dr["TransactionNo"] = WebApp.nwobjectText("txtReservationControlNo");
               //dr["CoBuyerCode"] = WebApp.nwobjectText("idvallugClient");//dr_details[SPR_COBUYER_CODE - 1].ToString();
                dr["CoBuyerName"]= dr_details[SPR_COBUYERNAME - 1].ToString();
                dr["DateofBirth"] = ValidateDate(dr_details[SPR_COBUYER_BIRTHDATE - 1].ToString()) ? dr_details[SPR_COBUYER_BIRTHDATE - 1].ToString() : (object)DBNull.Value;
                dr["Gender"]= dr_details[SPR_COBUYER_GENDERCODE - 1].ToString();
                dr["RelationshipCode"]=dr_details[SPR_COBUYER_RELATIONSHIPCODE - 1].ToString();
                dr["tinNo"] = dr_details[SPR_COBUYER_TINNO - 1].ToString();
                dr["Rownum"] = i;
                dtLIN.Rows.Add(dr);
                dtLIN.AcceptChanges();
                i++;
        ...
        public void GenerateGrid(bool isIntialize)
        {
            ...
            //var LineID = WebApp.nwobjectText("nwLineID");
            //if (LineID == "")
            //{
            //    if (isIntialize)
            //    {
            //        CreateGridContract("", true);
            //        CreateGridTieredNScaled("", true);
            //        CreateGridRegular("", true);
            //    }
            //    else
            //    {
            //        CreateGridContract("", false);
            //        CreateGridTieredNScaled("", false);
            //        CreateGridRegular("", false);
            //    }
            //}
            //else
            //{
            //    CreateGridContract(LineID, false);
            //    CreateGridTieredNScaled(LineID, false);
            //    CreateGridRegular(LineID, false);
            //}
        ...
        //    #region Column Width
        //    //nwGridCon.nwobject(SPR_UnitDetails_Category - 1).Width(160);
        //    //nwGridCon.nwobject(SPR_UnitDetails_UnitCode - 1).Width(150);
        //    //nwGridCon.nwobject(SPR_UnitDetails_UnitDesc - 1).Width(200);
        //    //nwGridCon.nwobject(SPR_UnitDetails_RefHoldingNo - 1).Width(200);
        ...
        //    //nwGridCon.SelectedRowHover("#DEDEDE");
        //    //nwGridCon.SelectedRowHoverColor("inherit");
        //    js.makeHTML("#nwGridUnitDetailsCon", nwGridCon.createTable());
        //    js.ADD("nwGrid_TableAdjust(\"" + gridID + "\")");
        //    js.ADD("nwGrid_TableFreeze(\"" + gridID + "\",0,0)");
        //    js.ADD("nwGrid_makeResize(\"" + gridID + "\")");
        //    //js.ADD("$('.btnUnitCapacity').enable(false);");
        //    js.ADD("setUnitDetailsPropOverride();");
        ...
        public void CreateGridPaymentTermDetails(string Code, bool isInitialize)
        {
            ...
            nwGridCon.nwobject(SPR_PaymentTermDetails_PaymentCategory - 1).Combo(dal.LoadCategory(WebApp.nwobjectText("idvallugFinancingType"), WebApp.nwobjectText("txtUnitCode"), WebApp.nwobjectText("idvallugBranchProject"), WebApp.nwobjectText("ddPhaseTower_temp"), WebApp.nwobjectText("txtUnitType"), WebApp.nwobjectText("txtUnitClass")), "clsCategory");
            ...
            //for lease to own entry 
            nwGridCon.nwobject(SPR_PaymentTermDetails_ContractAmount - 1).Width(0);
            nwGridCon.nwobject(SPR_PaymentTermDetails_SalesDiscount - 1).Width(0);
            nwGridCon.nwobject(SPR_PaymentTermDetails_DPDiscount - 1).Width(0);
            nwGridCon.nwobject(SPR_PaymentTermDetails_DPDiscountRate - 1).Width(0);
            nwGridCon.nwobject(SPR_PaymentTermDetails_DPDiscountAmount - 1).Width(0);
            ...
            nwGridCon.nwobject(SPR_PaymentTermDetails_ContractRate - 1).Template("<input value='{" + (SPR_PaymentTermDetails_ContractRate - 1) + "}' class='txtContractRate nwCuz-048 isNumber numC' nwdp='10'>"); //LUA
            nwGridCon.nwobject(SPR_PaymentTermDetails_TermAmount - 1).Template("<input value='{" + (SPR_PaymentTermDetails_TermAmount - 1) + "}' class='txtTermAmount nwCuz-048' disabled/>");
            nwGridCon.nwobject(SPR_PaymentTermDetails_DPDiscountRate - 1).Template("<input value='{" + (SPR_PaymentTermDetails_DPDiscountRate - 1) + "}'  class='SPR_PaymentTermDetails_DPDiscountRate' disabled/>");
            nwGridCon.nwobject(SPR_PaymentTermDetails_DPDiscountAmount - 1).Template("<input value='{" + (SPR_PaymentTermDetails_DPDiscountAmount - 1) + "}'  class='txtDPDiscountAmount' disabled/>");
            ...
            js.makeHTML("#nwGridPaymentTermDetailsCon", nwGridCon.createTable());
            js.ADD("nwGrid_TableAdjust(\"" + gridID + "\")");
            js.ADD("nwGrid_TableFreeze(\"" + gridID + "\",0,0)");
            js.ADD("nwGrid_makeResize(\"" + gridID + "\")");
            js.ADD("$('.nwCheckBoxTot').visible(false)");
            js.ADD("$(`#nwGridPaymentTermDetailsCon-nwData tr`).find(`td:eq(${SPR_PaymentTermDetails_DPDiscount}) input`).enable(false);");
            js.ADD("$(`#nwGridPaymentTermDetailsCon-nwData tr`).find(`td:eq(${SPR_PaymentTermDetails_DPDiscount})`).css('background-color', 'gainsboro');");
            js.ADD("DPDiscToggle();");
            js.ADD("MiscellaneousDetails();");
            js.ADD("PaymentTermProperties();");

            /* Remove first combobox in Payment Category */
            js.ADD("$('#nwGridPaymentTermDetails .nwSelect:eq(0)').remove(); ");
            //js.ADD("$('#nwGridPaymentTermDetails .nwCheckBox9:eq(0)').remove(); ");
        }
        #endregion
        ...
        public void CreateGridAddons(string Code, bool isInitialize)
        {
            ...
            js.makeHTML("#nwGridAddOnCon", nwGridCon.createTable());
            js.ADD("nwGrid_TableAdjust(\"" + gridID + "\")");
            js.ADD("nwGrid_TableFreeze(\"" + gridID + "\",0,0)");
            js.ADD("nwGrid_makeResize(\"" + gridID + "\")");
            js.ADD("propAddOns();");
        ...
        public void CreateGridDiscount(string Code, bool isInitialize)
        {
            ...
            nwGridCon.nwobject(SPR_Discount_DiscountRate - 1).Template("<input value='{" + (SPR_Discount_DiscountRate - 1) + "}'  class='txtDiscountRate nwCuz-048' />");
        ...
        public void CreateGridFreebiesPromosIncentives(string Code, bool isInitialize)
        {
            ...
            #region Column Templates                       
            nwGridCon.nwobject(SPR_FreebiesPromoIncentives_Qty - 1).Template("<input value = '{" + (SPR_FreebiesPromoIncentives_Qty - 1) + "}' class='txtSPR_FreebiesPromoIncentives_Qty isNumber numCnwCuz-048' />");
            nwGridCon.nwobject(SPR_FreebiesPromoIncentives_PriceVatIn - 1).Template("<input value = '{" + (SPR_FreebiesPromoIncentives_PriceVatIn - 1) + "}' class='txtSPR_FreebiesPromoIncentives_PriceVatIn isNumber numCnwCuz-048' />");
            nwGridCon.nwobject(SPR_FreebiesPromoIncentives_Amount - 1).Template("<input value = '{" + (SPR_FreebiesPromoIncentives_Amount - 1) + "}' class='txtSPR_FreebiesPromoIncentives_Amount isNumber numCnwCuz-048' nwdp='2' disabled/>");
            #endregion
        ...
        #region Term Details
        public void CreateTermDetails(bool isInitialize)
        {
            ...
            if (isInitialize)
            {
                dt = JSONToDataTable(WebApp.nwobjectText("jsonTermDetails"));
                nwGridCon.CreateExcelGrid(dt.Rows.Count, colCnt);
                nwGridCon.dataSource(dt);
                nwGridCon.maxRow(dt.Rows.Count + 1);
                //LoadQuery(dt, nwGridCon);
        ...
        public void CreateStatementDetails(string Code, bool isInitialize, DataTable jsonStatementDetails)
        {
            ...
            #region Column Templates
            nwGridCon.nwobject(SPR_STATEMENT_YES - 1).Template("<input type='radio' value='{" + (SPR_STATEMENT_YES - 1) + "}' class='radioSPR_STATEMENT_YES nwCuz-049'/>");
            nwGridCon.nwobject(SPR_STATEMENT_NO - 1).Template("<input type='radio' value='{" + (SPR_STATEMENT_NO - 1) + "}' class='radioSPR_STATEMENT_NO nwCuz-049'/>");
        ...
        public String Processvalidation()
        {
            ...
            string ret = dal.validateReqCompliance(WebApp.nwobjectText("txtDocNo"), "0", "HLDRES", "", "");

            if (ret == "0")
                errmess += $"Cannot be processed. Requirements Compliance is required.\n";
            else if (ret == "2")
                errmess += $"Cannot be processed. Transaction Requirements has been updated. Please reload details.\n";

            string revColor = dal.validatePendingReqUpdating(WebApp.nwobjectText("txtDocNo"));
            if (revColor == "Red") { errmess += $"Cannot be processed. There are pending documents requiring compliance updating for Transaction No. " + WebApp.nwobjectText("txtDocNo") + ".\n"; }
