...
function func_Reload() {
    ...
    crLnk = GetCurrentURL() + "APVendorPriceAssignReport_Gateway";
    crLnkGateKey = "APVendorPriceAssignReport";
    //crnwTagSingleBind = true;

    $("#settingstabs").loadAddtoList({ list: ["Item", "Vendor", "Uploaded By"], icon: true });
...
function cust_GetPara() {
    nwParameter_Add("txtAsofDate", $('#txtAsofDate').val());
