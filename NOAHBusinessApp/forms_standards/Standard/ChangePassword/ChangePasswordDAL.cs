...
{
    public class ChangePasswordDAL : NoahWebLib.DatabaseHandler
    {
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public ChangePasswordDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
