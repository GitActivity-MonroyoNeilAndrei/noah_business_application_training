...
{
    public class SBDeactivatedClientRegSummRptController : nwStandardGateway
    {
        public ActionResult Index()
        {
            mainDataAccess main = new mainDataAccess();
            main.MenuAccess(User, this);
            return View(@"~\SB\ReportsAndInquiry\SBDeactivatedClientRegSummRpt\SBDeactivatedClientRegSummRpt.cshtml");
        }
        ...
        public ActionResult Index2()
        {
            Response.Write("AA1");
            return null;
            //return View(@"~\RE\ReportsAndInquiry\SBDeactivatedClientRegSummRpt\SBDeactivatedClientRegSummRpt.cshtml");
        }

        public ActionResult SBDeactivatedClientRegSummRpt_Gateway()
        {
            ...
            if (DLLAutoGateway == false) // for redirecting of BL (4 tier)
            {
                try
                {
                    SBDeactivatedClientRegSummRptBL menuBL = new SBDeactivatedClientRegSummRptBL();
                    based.Title = "Deactivated Client Registration Summary";
