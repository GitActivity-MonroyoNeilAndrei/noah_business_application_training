...
{
    public class PrivacyPolicyDAL : NoahWebLib.DatabaseHandler
    {
        nwSFObjects SFObjects = new nwSFObjects();
        #region STANDARD

        public string MenuItemCode = "PrivacyPolicy"; // This is default parameter  for version
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public PrivacyPolicyDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
