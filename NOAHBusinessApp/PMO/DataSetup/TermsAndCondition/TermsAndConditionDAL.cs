...
{
    public class TermsAndConditionDAL : NoahWebLib.DatabaseHandler
    {
        nwSFObjects SFObjects = new nwSFObjects();
        #region STANDARD

        public string MenuItemCode = "TermsAndCondition"; // This is default parameter  for version
...
                                ", MenuItemCode, MenuItemVersion)
        ...
        public TermsAndConditionDAL(string ConnectionString, string ConnectionString2, string selectedItem)
        {
        ...
        {
            return SFObjects.returnText($@"EXEC [zAPI].[nsp_Mob_Assets] @QueryType = 0", _ConnectionString2);
        }
